...
**credit_invoices** | [**\Frisbii\Model\CreditInvoice[]**](CreditInvoice.md) | List of invoices where the credit is applied | [optional] 
**pending_amount** | **int** | Remaining amount not transferred to invoices | 
**invoice_credit_note** | [**\Frisbii\Model\InvoiceCreditNote**](InvoiceCreditNote.md) |  | [optional] 
