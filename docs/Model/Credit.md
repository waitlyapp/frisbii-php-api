...
**credit_invoices** | [**\Frisbii\lib/Model\CreditInvoice[]**](CreditInvoice.md) | List of invoices where the credit is applied | [optional] 
**pending_amount** | **int** | Remaining amount not transferred to invoices | 
**invoice_credit_note** | [**\Frisbii\lib/Model\InvoiceCreditNote**](InvoiceCreditNote.md) |  | [optional] 
