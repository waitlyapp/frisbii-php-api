...
**credits** | [**\Billwerk\Model\CreditInvoice[]**](CreditInvoice.md) | Credits applied to invoice | 
...
**order_lines** | [**\Billwerk\Model\OrderLine[]**](OrderLine.md) | Order lines for invoice sorted by descending timestamp | 
**additional_costs** | **string[]** | Additional cost handles for any additional costs added to this invoice | 
**transactions** | [**\Billwerk\Model\Transaction[]**](Transaction.md) | Invoice transactions | 
...
**credit_notes** | [**\Billwerk\Model\InvoiceCreditNote[]**](InvoiceCreditNote.md) | Invoice credit notes | [optional] 
