...
**invoices** | [**\Frisbii\Model\Invoice[]**](Invoice.md) | List of created (prepared) invoices for prepared subscription | [optional]
...
**nextInvoice** | [**\Frisbii\Model\Invoice**](Invoice.md) |  | [optional]
