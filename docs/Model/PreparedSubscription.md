...
**invoices** | [**\Billwerk\Model\Invoice[]**](Invoice.md) | List of created (prepared) invoices for prepared subscription | [optional] 
...
**hosted_page_links** | [**\Billwerk\Model\SubscriptionLinks**](SubscriptionLinks.md) |  | 
**subscription_discounts** | **string[]** | List of subscription discounts handles attached to subscription | [optional] 
**pending_change** | [**\Billwerk\Model\SubscriptionChange**](SubscriptionChange.md) |  | [optional] 
**subscription_changes** | [**\Billwerk\Model\SubscriptionChange[]**](SubscriptionChange.md) | List of subscription changes both at most one pending and previously applied | [optional] 
