...
class CreditApi
{
     ...
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Billwerk\Model\Credit, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelCreditWithHttpInfo($handle)
    {
        $returnType = '\Billwerk\Model\Credit';
     ...
     * Create credit
     *
     * @param  \Billwerk\Model\CreateCredit $body body (required)
     *
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Billwerk\Model\Credit
     ...
     * Create credit
     *
     * @param  \Billwerk\Model\CreateCredit $body (required)
     *
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Billwerk\Model\Credit, HTTP status code, HTTP response headers (array of strings)
