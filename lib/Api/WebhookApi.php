...
class WebhookApi
{
     ...
     * Disable webhooks
     *
     * @param  \Frisbii\Model\WebhookDisableRequest $body body (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Frisbii\Model\Webhook[]
     */
     ...
     * Disable webhooks
     *
     * @param  \Frisbii\Model\WebhookDisableRequest $body (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Frisbii\Model\Webhook[], HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Frisbii\Model\WebhookRequest[]
     */
     ...
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Frisbii\Model\WebhookRequest[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        list($response) = $this->getWebhooksWithHttpInfo($created_before, $size, $state, $event, $created_after);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhooksAsync($created_before, $size = '100', $state = null, $event = null, $created_after = null)
    {
        return $this->getWebhooksAsyncWithHttpInfo($created_before, $size, $state, $event, $created_after)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWebhooksRequest($created_before, $size = '100', $state = null, $event = null, $created_after = null)
    {
     ...
     * Re-send webhooks
     *
     * @param  \Frisbii\Model\WebhookResendRequest $body body (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Frisbii\Model\Webhook[]
     ...
     * Re-send webhooks
     *
     * @param  \Frisbii\Model\WebhookResendRequest $body (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Frisbii\Model\Webhook[], HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \Frisbii\Model\WebhookUpdateRequest $body body (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Frisbii\Model\Webhook[]
     ...
     * Update and resend webhooks
     *
     * @param  \Frisbii\Model\WebhookUpdateRequest $body (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Frisbii\Model\Webhook[], HTTP status code, HTTP response headers (array of strings)
