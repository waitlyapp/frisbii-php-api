...
class ChargeApi
{
     ...
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Billwerk\Model\Charge, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelChargeWithHttpInfo($handle)
    {
        $returnType = '\Billwerk\Model\Charge';
     ...
     * Create charge
     *
     * @param  \Billwerk\Model\CreateCharge $body body (required)
     *
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Billwerk\Model\Charge
     ...
     * Create charge
     *
     * @param  \Billwerk\Model\CreateCharge $body (required)
     *
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Billwerk\Model\Charge, HTTP status code, HTTP response headers (array of strings)
     ...
     * Prepare charge
     *
     * @param  \Billwerk\Model\PrepareChargeDto $body body (required)
     *
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Billwerk\Model\Charge
     ...
     * Prepare charge
     *
     * @param  \Billwerk\Model\PrepareChargeDto $body (required)
     *
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Billwerk\Model\Charge, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  string $handle Charge handle (required)
     * @param  \Billwerk\Model\SettleCharge $body body (optional)
     *
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Billwerk\Model\Charge
     ...
     *
     * @param  string $handle Charge handle (required)
     * @param  \Billwerk\Model\SettleCharge $body (optional)
     *
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Billwerk\Model\Charge, HTTP status code, HTTP response headers (array of strings)
