...
class PlanApi
{
     ...
     * Change plan amount
     *
     * @param  \Frisbii\Model\ChangePlanAmount $body body (required)
     * @param  string $handle Plan handle (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Frisbii\Model\Plan
     */
    public function changePlanAmountJson($body, $handle)
    {
        list($response) = $this->changePlanAmountJsonWithHttpInfo($body, $handle);
        return $response;
    }
     ...
     * Change plan amount
     *
     * @param  \Frisbii\Model\ChangePlanAmount $body (required)
     * @param  string $handle Plan handle (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Frisbii\Model\Plan, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     */
    public function changePlanAmountJsonAsync($body, $handle)
    {
        return $this->changePlanAmountJsonAsyncWithHttpInfo($body, $handle)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function changePlanAmountJsonRequest($body, $handle)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling changePlanAmountJson'
            );
        }
     ...
     * Create plan
     *
     * @param  \Frisbii\Model\CreateSubscriptionPlan $body body (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Frisbii\Model\Plan
     ...
     * Create plan
     *
     * @param  \Frisbii\Model\CreateSubscriptionPlan $body (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Frisbii\Model\Plan, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return void
     */
    public function deleteMetadata6($handle)
    {
        $this->deleteMetadata6WithHttpInfo($handle);
    }
     ...
     */
    public function deleteMetadata6WithHttpInfo($handle)
    {
        $returnType = '';
        $request = $this->deleteMetadata6Request($handle);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteMetadata6Async($handle)
    {
        return $this->deleteMetadata6AsyncWithHttpInfo($handle)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteMetadata6AsyncWithHttpInfo($handle)
    {
        $returnType = '';
        $request = $this->deleteMetadata6Request($handle);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteMetadata6Request($handle)
    {
        // verify the required parameter 'handle' is set
        if ($handle === null || (is_array($handle) && count($handle) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getMetadata6($handle)
    {
        list($response) = $this->getMetadata6WithHttpInfo($handle);
        return $response;
    }
     ...
     */
    public function getMetadata6WithHttpInfo($handle)
    {
        $returnType = 'map[string,object]';
        $request = $this->getMetadata6Request($handle);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetadata6Async($handle)
    {
        return $this->getMetadata6AsyncWithHttpInfo($handle)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetadata6AsyncWithHttpInfo($handle)
    {
        $returnType = 'map[string,object]';
        $request = $this->getMetadata6Request($handle);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMetadata6Request($handle)
    {
        // verify the required parameter 'handle' is set
        if ($handle === null || (is_array($handle) && count($handle) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        list($response) = $this->getPlanEntitlementsWithHttpInfo($handle, $version);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPlanEntitlementsAsync($handle, $version)
    {
        return $this->getPlanEntitlementsAsyncWithHttpInfo($handle, $version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPlanEntitlementsRequest($handle, $version)
    {
        // verify the required parameter 'handle' is set
        if ($handle === null || (is_array($handle) && count($handle) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * Supersede plan
     *
     * @param  \Frisbii\Model\SupersedeSubscriptionPlan $body body (required)
     * @param  string $handle Plan handle (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Supersede plan
     *
     * @param  \Frisbii\Model\SupersedeSubscriptionPlan $body (required)
     * @param  string $handle Plan handle (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return map[string,object]
     */
    public function updateMetadata6($body, $handle)
    {
        list($response) = $this->updateMetadata6WithHttpInfo($body, $handle);
        return $response;
    }
     ...
     * @return array of map[string,object], HTTP status code, HTTP response headers (array of strings)
     */
    public function updateMetadata6WithHttpInfo($body, $handle)
    {
        $returnType = 'map[string,object]';
        $request = $this->updateMetadata6Request($body, $handle);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMetadata6Async($body, $handle)
    {
        return $this->updateMetadata6AsyncWithHttpInfo($body, $handle)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMetadata6AsyncWithHttpInfo($body, $handle)
    {
        $returnType = 'map[string,object]';
        $request = $this->updateMetadata6Request($body, $handle);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateMetadata6Request($body, $handle)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateMetadata6'
            );
        }
        // verify the required parameter 'handle' is set
        if ($handle === null || (is_array($handle) && count($handle) === 0)) {
     ...
     * Update plan
     *
     * @param  \Frisbii\Model\UpdateSubscriptionPlan $body body (required)
     ...
     * Update plan
     *
     * @param  \Frisbii\Model\UpdateSubscriptionPlan $body (required)
     * @param  string $handle Subscription handle (required)
     *
     * @throws \Frisbii\ApiException on non-2xx response
     * @throws \InvalidArgumentException
