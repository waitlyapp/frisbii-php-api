...
class EventApi
{
     ...
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Billwerk\Model\Event, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEventWithHttpInfo($id)
    {
        $returnType = '\Billwerk\Model\Event';
     ...
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Billwerk\Model\EventList
     */
     ...
     * @throws \Billwerk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Billwerk\Model\EventList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEventsWithHttpInfo($page = '1', $size = '20', $customer = null, $subscription = null, $invoice = null)
    {
        $returnType = '\Billwerk\Model\EventList';
