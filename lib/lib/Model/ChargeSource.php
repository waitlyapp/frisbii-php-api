...
class ChargeSource implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'sepa_mandate' => 'string',
        'sepa_ebics_mandate' => 'string',
        'twint_mandate' => 'string',
        'paypal_mandate' => 'string',
    ...
    protected static $attributeMap = [
        ...
        'sepa_ebics_mandate' => 'sepa_ebics_mandate',
        'twint_mandate' => 'twint_mandate',
        'paypal_mandate' => 'paypal_mandate',
    ...
    protected static $setters = [
        ...
        'sepa_ebics_mandate' => 'setSepaEbicsMandate',
        'twint_mandate' => 'setTwintMandate',
        'paypal_mandate' => 'setPaypalMandate',
    ...
    protected static $getters = [
        ...
        'sepa_ebics_mandate' => 'getSepaEbicsMandate',
        'twint_mandate' => 'getTwintMandate',
        'paypal_mandate' => 'getPaypalMandate',
    ...
    const TYPE_VIPPS_EPAYMENT = 'vipps_epayment';
    ...
    const PROVIDER_AIBMS = 'aibms';
    const PROVIDER_BAMBORA = 'bambora';
    const PROVIDER_BARCLAYS = 'barclays';
    const PROVIDER_CLEARHAUS = 'clearhaus';
    const PROVIDER_CMCIC = 'cmcic';
    const PROVIDER_CREDIBANCO = 'credibanco';
    const PROVIDER_CS = 'cs';
    const PROVIDER_ELAVON = 'elavon';
    const PROVIDER_EVRY = 'evry';
    const PROVIDER_FIRST_DATA = 'first_data';
    const PROVIDER_HANDELSBANKEN = 'handelsbanken';
    const PROVIDER_HSBC = 'hsbc';
    const PROVIDER_NETS = 'nets';
    const PROVIDER_SHIFT4 = 'shift4';
    const PROVIDER_SPREEDLY = 'spreedly';
    const PROVIDER_SWEDBANK = 'swedbank';
    const PROVIDER_THAILAND_KBANK = 'thailand_kbank';
    const PROVIDER_VALITOR = 'valitor';
    const PROVIDER_WORLDLINE = 'worldline';
    const PROVIDER_WORLDPAY = 'worldpay';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sepa_ebics_mandate'] = isset($data['sepa_ebics_mandate']) ? $data['sepa_ebics_mandate'] : null;
        $this->container['twint_mandate'] = isset($data['twint_mandate']) ? $data['twint_mandate'] : null;
        $this->container['paypal_mandate'] = isset($data['paypal_mandate']) ? $data['paypal_mandate'] : null;
     ...
     * Sets iban
     *
     * @param string $iban IBAN number if source type `sepa` and `sepa_ebics`
     *
     * @return $this
     */
     ...
     * Sets provider
     *
     * @param string $provider Card acquirer or card payment gateway used if card source: `reepay`, `aibms`, `bambora`, `barclays`, `clearhaus`, `cmcic`, `credibanco`, `cs`,  `elavon`, `evry`, `first_data`, `handelsbanken`, `hsbc`, `nets`, `shift4`, `spreedly`, `swedbank`, `thailand_kbank`, `valitor`, `worldline`, `worldpay`, `test`
     *
     * @return $this
     */
    ...
    {
        return $this->container['sepa_ebics_mandate'];
    }

    /**
     * Sets sepa_ebics_mandate
     *
     * @param string $sepa_ebics_mandate Reference to SEPA EBICS Mandate payment method if source type `sepa_ebics`
     *
     * @return $this
     */
    public function setSepaEbicsMandate($sepa_ebics_mandate)
    {
        $this->container['sepa_ebics_mandate'] = $sepa_ebics_mandate;
     ...
     * Sets twint_mandate
     *
     * @param string $twint_mandate Reference to Twint Mandate payment method if source type `twint`
     *
     * @return $this
     */
    ...
    {
        return $this->container['paypal_mandate'];
    }

    /**
     * Sets paypal_mandate
     *
     * @param string $paypal_mandate Reference to PayPal Mandate payment method if source type `paypal`
     *
     * @return $this
     */
    public function setPaypalMandate($paypal_mandate)
    {
        $this->container['paypal_mandate'] = $paypal_mandate;
     ...
     *
     * @param string $offline_payment_instructions Offline payment instructions if source type `offline_cash`, `offline_bank_transfer`, `offline_other`
     *
     * @return $this
     */
     ...
     * Sets card_type
     *
     * @param string $card_type Card type if credit card source: `unknown`, `visa`, `mc`, `dankort`, `visa_dk`, `ffk`, `visa_elec`, `maestro`, `laser`, `amex`, `diners`, `discover`, `jcb` or `china_union_pay`
     *
     * @return $this
     */
     ...
     *
     * @param string $transaction_card_type Transaction card type if credit card source. Will differ from `card_type` if co-branded card. Transaction card type is the card type used for the transaction. `unknown`, `visa`, `mc`, `dankort`, `visa_dk`, `ffk`, `visa_elec`, `maestro`, `laser`, `amex`, `diners`, `discover`, `jcb` or `china_union_pay`
     *
     * @return $this
     */
     ...
     * Sets risk_rule
     *
     * @param string $risk_rule If this parameter is set the charge has either been flagged or declined by a Frisbii Risk Filter rule. For flag action rules the charge can be successful, but may require special attention. For block action rules the decline error will be `risk_filter_block`.
     *
     * @return $this
     */
