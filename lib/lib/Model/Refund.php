...
class Refund implements ModelInterface, ArrayAccess
{
     ...
     * Sets error_state
     *
     * @param string $error_state Frisbii error state if failed: `hard_declined` or `processing_error`. A hard decline indicates a refund decline by acquirer. A processing error indicates an error processing the refund either at Frisbii, the acquirer, or between Frisbii and the acquirer.
     *
     * @return $this
     */
