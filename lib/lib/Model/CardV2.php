...
class CardV2 implements ModelInterface, ArrayAccess
{
    ...
    const TOKEN_STATE_SUSPENDED = 'suspended';
    const TOKEN_STATE_DELETED = 'deleted';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['token_state'] = isset($data['token_state']) ? $data['token_state'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['token_state']) && !in_array($this->container['token_state'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'token_state', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets card_type
     *
     * @param string $card_type Card type: `unknown`, `visa`, `mc`, `dankort`, `visa_dk`, `ffk`, `visa_elec`, `maestro`, `laser`, `amex`, `diners`, `discover`, `jcb` or `china_union_pay`
     *
     * @return $this
     */
     ...
     *
     * @param string $transaction_card_type Card type used in authentication and the card type used for subsequent MIT transactions. Will differ from `card_type` if co-branded card. `unknown`, `visa`, `mc`, `dankort`, `visa_dk`, `ffk`, `visa_elec`, `maestro`, `laser`, `amex`, `diners`, `discover`, `jcb` or `china_union_pay`
     *
     * @return $this
     */
     ...
     * Sets error_code
     *
     * @param string $error_code An error code from the last failed use of the card. See [transaction errors](https://docs.frisbii.com/reference/transaction_errors).
     *
     * @return $this
     */
     ...
     * Sets risk_rule
     *
     * @param string $risk_rule If this parameter is set the card has been flagged by Frisbii Risk Filter with a flag rule. Special attention may be required before using the card for recurring payments or subscription sign-up.
     *
     * @return $this
     */
    ...
    {
        return $this->container['token_state'];
    }

    /**
     * Sets token_state
     *
     * @param string $token_state State of tokenization for card `active`, `suspended` or `deleted`
     *
     * @return $this
     */
    public function setTokenState($token_state)
    {
        $allowedValues = $this->getTokenStateAllowableValues();
        if (!is_null($token_state) && !in_array($token_state, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'token_state', must be one of '%s'",
                    implode("', '", $allowedValues)
        ...
        $this->container['token_state'] = $token_state;
