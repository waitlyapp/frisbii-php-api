...
class InvoiceCreditNoteV2 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'amount_vat' => 'int',
        'amount_ex_vat' => 'int',
        'credit_note_lines' => '\Frisbii\Model\CreditNoteLine[]',
        'accounting_number' => 'string',
        'debtor_id' => 'int',
        'download_url' => 'string',
        'accounting_created_date' => '\DateTime',
        'payable_amount' => 'int',
        'amount_vat_lines' => '\Frisbii\Model\AmountVatLine[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'amount_vat_lines' => 'amount_vat_lines'
    ];
    ...
    protected static $setters = [
        ...
        'amount_vat_lines' => 'setAmountVatLines'
    ];
    ...
    protected static $getters = [
        ...
        'amount_vat_lines' => 'getAmountVatLines'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['amount_vat_lines'] = isset($data['amount_vat_lines']) ? $data['amount_vat_lines'] : null;
    }
     ...
     *
     * @param \Frisbii\Model\CreditNoteLine[] $credit_note_lines Credit note lines
     *
     * @return $this
     */
     ...
     * Sets download_url
     *
     * @param string $download_url Link to the credit note PDF, available if PDF generation and accounting features are enabled (only for subscription invoices, not charges). Access requires authentication. See https://docs.frisbii.com/reference/authentication. The response is a binary PDF file.
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\AmountVatLine[]
     */
    public function getAmountVatLines()
    {
        return $this->container['amount_vat_lines'];
    }

    /**
     * Sets amount_vat_lines
     *
     * @param \Frisbii\Model\AmountVatLine[] $amount_vat_lines The list of VAT amounts grouped by VAT percentage
     *
     * @return $this
     */
    public function setAmountVatLines($amount_vat_lines)
    {
        $this->container['amount_vat_lines'] = $amount_vat_lines;
