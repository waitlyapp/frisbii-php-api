 ...
 */
class InvoiceCreditNoteV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceCreditNoteV2';
    ...
    protected static $openAPITypes = [
        ...
        'payableAmount' => 'int',
        'amountVatLines' => '\Frisbii\Model\AmountVatLine[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'amountVatLines' => 'amount_vat_lines'
    ];
    ...
    protected static $setters = [
        ...
        'amountVatLines' => 'setAmountVatLines'
    ];
    ...
    protected static $getters = [
        ...
        'amountVatLines' => 'getAmountVatLines'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payableAmount', $data ?? [], null);
        $this->setIfExists('amountVatLines', $data ?? [], null);
    }
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling InvoiceCreditNoteV2., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling InvoiceCreditNoteV2., must be bigger than or equal to 1.');
        }
     ...
     * Sets credits
     *
     * @param \Frisbii\Model\CreditInvoice[] $credits Credits applied to credit note
     *
     * @return self
     */
    ...
    {
        return $this->container['payableAmount'];
    }

    /**
     * Sets payableAmount
     *
     * @param int|null $payableAmount The credit note amount to be payed including VAT
     *
     * @return self
     */
    public function setPayableAmount($payableAmount)
    {
        if (is_null($payableAmount)) {
            throw new \InvalidArgumentException('non-nullable payableAmount cannot be null');
        }
        $this->container['payableAmount'] = $payableAmount;
     ...
     * Gets amountVatLines
     *
     * @return \Frisbii\Model\AmountVatLine[]|null
     */
    public function getAmountVatLines()
    {
        return $this->container['amountVatLines'];
    }

    /**
     * Sets amountVatLines
     *
     * @param \Frisbii\Model\AmountVatLine[]|null $amountVatLines The list of VAT amounts grouped by VAT percentage
     *
     * @return self
     */
    public function setAmountVatLines($amountVatLines)
    {
        if (is_null($amountVatLines)) {
            throw new \InvalidArgumentException('non-nullable amountVatLines cannot be null');
        }
        $this->container['amountVatLines'] = $amountVatLines;
