...
class OrderLine implements ModelInterface, ArrayAccess
{
    ...
    protected static $attributeMap = [
        ...
        'applied_tax_rule' => 'applied_tax_rule',
    ...
    protected static $setters = [
        ...
        'applied_tax_rule' => 'setAppliedTaxRule',
    ...
    protected static $getters = [
        ...
        'applied_tax_rule' => 'getAppliedTaxRule',
    ...
    const ORIGIN_METERED_BILLING_PRODUCT = 'metered_billing_product';
    const APPLIED_TAX_RULE_REVERSE_CHARGE = 'reverse_charge';
    const APPLIED_TAX_RULE_INTRA_COMMUNITY_DIGITAL_SERVICE = 'intra_community_digital_service';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['applied_tax_rule'] = isset($data['applied_tax_rule']) ? $data['applied_tax_rule'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['applied_tax_rule']) && !in_array($this->container['applied_tax_rule'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'applied_tax_rule', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
    ...
    /**
     * Gets applied_tax_rule
     *
     * @return string
     */
    public function getAppliedTaxRule()
    {
        return $this->container['applied_tax_rule'];
    }

    /**
     * Sets applied_tax_rule
     *
     * @param string $applied_tax_rule Tax rule applied for order line indicates who is liable to account for the VAT.
     *
     * @return $this
     */
    public function setAppliedTaxRule($applied_tax_rule)
    {
        $allowedValues = $this->getAppliedTaxRuleAllowableValues();
        if (!is_null($applied_tax_rule) && !in_array($applied_tax_rule, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'applied_tax_rule', must be one of '%s'",
                    implode("', '", $allowedValues)
        ...
        $this->container['applied_tax_rule'] = $applied_tax_rule;
