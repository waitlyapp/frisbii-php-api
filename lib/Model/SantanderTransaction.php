 ...
 */
class SantanderTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SantanderTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('santanderId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['santanderId'];
    }

    /**
     * Sets santanderId
     *
     * @param string|null $santanderId Santander id
     *
     * @return self
     */
    public function setSantanderId($santanderId)
    {
        if (is_null($santanderId)) {
            throw new \InvalidArgumentException('non-nullable santanderId cannot be null');
        }
        $this->container['santanderId'] = $santanderId;
