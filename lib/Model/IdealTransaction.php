 ...
 */
class IdealTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IdealTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('idealId', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets idealId
     *
     * @param string|null $idealId Ideal id
     *
     * @return self
     */
    ...
    {
        if (is_null($idealId)) {
            throw new \InvalidArgumentException('non-nullable idealId cannot be null');
        }
