 ...
 */
class KlarnaAgreement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KlarnaAgreement';
    ...
    public const PAYMENT_TYPE_PAY_NOW = 'klarna_pay_now';
    public const PAYMENT_TYPE_PAY_LATER = 'klarna_pay_later';
    public const PAYMENT_TYPE_SLICE_IT = 'klarna_slice_it';
    public const PAYMENT_TYPE_DIRECT_BANK_TRANSFER = 'klarna_direct_bank_transfer';
    public const PAYMENT_TYPE_DIRECT_DEBIT = 'klarna_direct_debit';
    ...
    */
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling KlarnaAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling KlarnaAgreement., must be bigger than or equal to 1.');
        }
