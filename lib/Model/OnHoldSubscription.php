 ...
 */
class OnHoldSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OnHoldSubscription';
    ...
    */
     ...
     *
     * @param string|null $compensationMethod Optional method for compensation of partial period, either `full_refund`, `prorated_refund`, `full_credit`, `prorated_credit` or `none`. Default is `none`. Refund compensation is only allowed for synchronous refund payment methods, e.g. credit cards.
     *
     * @return self
     */
