...
class OfflineTransaction implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['offline_payment_instructions'] === null) {
            $invalidProperties[] = "'offline_payment_instructions' can't be null";
        }
     ...
     *
     * @param string $offline_payment_instructions Offline payment instructions, either default from agreement or overriding from charge parameters
     *
     * @return $this
     */
