 ...
 */
class OfflineTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfflineTransaction';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['offlinePaymentInstructions'] === null) {
            $invalidProperties[] = "'offlinePaymentInstructions' can't be null";
        }
     ...
     *
     * @param string $offlinePaymentInstructions Offline payment instructions, either default from agreement or overriding from charge parameters
     *
     * @return self
     */
     ...
     *
     * @param string|null $offlineAgreementHandle Offline agreement handle used to initiate transaction. Only set when `offline_mandate` is not set
     *
     * @return self
     */
     ...
     * Sets paymentDueDate
     *
     * @param \DateTime|null $paymentDueDate paymentDueDate
     *
     * @return self
     */
