...
class CreatePreparedSubscription implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'create_customer' => '\Billwerk\Model\CreateCustomer',
        'plan_version' => 'int',
        ...
        'no_setup_fee' => 'bool',
        'trial_period' => 'string',
        'subscription_discounts' => '\Billwerk\Model\CreateSubscriptionDiscount[]',
        'coupon_codes' => 'string[]',
        'add_ons' => '\Billwerk\Model\CreateSubscriptionAddOn[]',
        'additional_costs' => '\Billwerk\Model\CreateSubscriptionAdditionalCost[]'
    ];
     ...
     *
     * @param \Billwerk\Model\CreateCustomer $create_customer create_customer
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\CreateSubscriptionDiscount[]
     */
     ...
     *
     * @param \Billwerk\Model\CreateSubscriptionDiscount[] $subscription_discounts Discounts to attach to subscription. A maximum of 100 discounts is allowed.
     *
     * @return $this
     */
     ...
     * Gets add_ons
     *
     * @return \Billwerk\Model\CreateSubscriptionAddOn[]
     */
     ...
     * Sets add_ons
     *
     * @param \Billwerk\Model\CreateSubscriptionAddOn[] $add_ons Add-ons to attach to subscription. The same add-on can only be attached to subscription once unless unique handles are supplied for the subscription add-on. A maximum of 100 add-ons is allowed.
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\CreateSubscriptionAdditionalCost[]
     */
     ...
     *
     * @param \Billwerk\Model\CreateSubscriptionAdditionalCost[] $additional_costs Additional costs to add to subscription at creation time. A maximum of 100 additional costs is allowed.
     *
     * @return $this
     */
