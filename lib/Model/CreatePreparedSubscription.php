 ...
 */
class CreatePreparedSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePreparedSubscription';
    ...
    */
    ...
    public function setSubscriptionDiscounts($subscriptionDiscounts)
    {
        ...
        if ((count($subscriptionDiscounts) > 100)) {
            throw new \InvalidArgumentException('invalid value for $subscriptionDiscounts when calling CreatePreparedSubscription., number of items must be less than or equal to 100.');
        }
        if ((count($subscriptionDiscounts) < 0)) {
            throw new \InvalidArgumentException('invalid length for $subscriptionDiscounts when calling CreatePreparedSubscription., number of items must be greater than or equal to 0.');
        }
    ...
    public function setAddOns($addOns)
    {
        ...
        if ((count($addOns) > 100)) {
            throw new \InvalidArgumentException('invalid value for $addOns when calling CreatePreparedSubscription., number of items must be less than or equal to 100.');
        }
        if ((count($addOns) < 0)) {
            throw new \InvalidArgumentException('invalid length for $addOns when calling CreatePreparedSubscription., number of items must be greater than or equal to 0.');
        }
    ...
    public function setAdditionalCosts($additionalCosts)
    {
        ...
        if ((count($additionalCosts) > 100)) {
            throw new \InvalidArgumentException('invalid value for $additionalCosts when calling CreatePreparedSubscription., number of items must be less than or equal to 100.');
        }
        if ((count($additionalCosts) < 0)) {
            throw new \InvalidArgumentException('invalid length for $additionalCosts when calling CreatePreparedSubscription., number of items must be greater than or equal to 0.');
        }
