 ...
 */
class ViabillTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViabillTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('viabillId', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets viabillId
     *
     * @param string|null $viabillId ViaBill id
     *
     * @return self
     */
    public function setViabillId($viabillId)
    {
        if (is_null($viabillId)) {
            throw new \InvalidArgumentException('non-nullable viabillId cannot be null');
        }
