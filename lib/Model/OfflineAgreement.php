 ...
 */
class OfflineAgreement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfflineAgreement';
    ...
    public const PAYMENT_TYPE_BANK_TRANSFER = 'offline_bank_transfer';
    public const PAYMENT_TYPE_CASH = 'offline_cash';
    public const PAYMENT_TYPE_OTHER = 'offline_other';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OfflineAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setInstructions($instructions)
    {
        ...
        if ((mb_strlen($instructions) < 1)) {
            throw new \InvalidArgumentException('invalid length for $instructions when calling OfflineAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setHandle($handle)
    {
        ...
        if ((mb_strlen($handle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $handle when calling OfflineAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentTermsInDays($paymentTermsInDays)
    {
        ...
        if (($paymentTermsInDays > 9999)) {
            throw new \InvalidArgumentException('invalid value for $paymentTermsInDays when calling OfflineAgreement., must be smaller than or equal to 9999.');
        }
        if (($paymentTermsInDays < 1)) {
            throw new \InvalidArgumentException('invalid value for $paymentTermsInDays when calling OfflineAgreement., must be bigger than or equal to 1.');
        }
