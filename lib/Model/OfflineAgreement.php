...
class OfflineAgreement implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'payment_terms_in_days' => 'setPaymentTermsInDays',
    ...
    protected static $getters = [
        ...
        'payment_terms_in_days' => 'getPaymentTermsInDays',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_terms_in_days'] = isset($data['payment_terms_in_days']) ? $data['payment_terms_in_days'] : null;
     ...
     * Sets logo
     *
     * @param string $logo Optional payment method logo url. Must be hosted on a *.frisbii.com domain.
     *
     * @return $this
     */
    ...
    /**
     * Gets payment_terms_in_days
     *
     * @return int
     */
    public function getPaymentTermsInDays()
    {
        return $this->container['payment_terms_in_days'];
    }

    /**
     * Sets payment_terms_in_days
     *
     * @param int $payment_terms_in_days Optional payment terms in days, default 14 days for pending and 0 for instant
     *
     * @return $this
     */
    public function setPaymentTermsInDays($payment_terms_in_days)
    {
        $this->container['payment_terms_in_days'] = $payment_terms_in_days;
