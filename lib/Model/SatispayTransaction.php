 ...
 */
class SatispayTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SatispayTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('satispayId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['satispayId'];
    }

    /**
     * Sets satispayId
     *
     * @param string|null $satispayId Satispay id
     *
     * @return self
     */
    public function setSatispayId($satispayId)
    {
        if (is_null($satispayId)) {
            throw new \InvalidArgumentException('non-nullable satispayId cannot be null');
        }
        $this->container['satispayId'] = $satispayId;
