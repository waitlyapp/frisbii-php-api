 ...
 */
class PayoutList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayoutList';
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling PayoutList., must be bigger than or equal to 10.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\Payout[] $content List of payouts for current page
     *
     * @return self
     */
