 ...
 */
class SubscriptionLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionLinks';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['paymentInfo']) < 1)) {
            $invalidProperties[] = "invalid value for 'paymentInfo', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setPaymentInfo($paymentInfo)
    {
        ...
        if ((mb_strlen($paymentInfo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $paymentInfo when calling SubscriptionLinks., must be bigger than or equal to 1.');
        }
