 ...
 */
class MultibancoTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MultibancoTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('multibancoId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['multibancoId'];
    }

    /**
     * Sets multibancoId
     *
     * @param string|null $multibancoId Multibanco id
     *
     * @return self
     */
    public function setMultibancoId($multibancoId)
    {
        if (is_null($multibancoId)) {
            throw new \InvalidArgumentException('non-nullable multibancoId cannot be null');
        }
        $this->container['multibancoId'] = $multibancoId;
