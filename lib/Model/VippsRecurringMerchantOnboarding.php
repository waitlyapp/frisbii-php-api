 ...
 */
class VippsRecurringMerchantOnboarding implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VippsRecurringMerchantOnboarding';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[\\d-]{4,50}$/", $this->container['organizationNumber'])) {
            $invalidProperties[] = "invalid value for 'organizationNumber', must be conform to the pattern /^[\\d-]{4,50}$/.";
        }
     ...
     *
     * @param string $organizationNumber Organisation number of the merchant for whom the partner is submitting the product order. Norwegian, Danish and Finnish organization numbers are allowed (for now).
     *
     * @return self
     */
    public function setOrganizationNumber($organizationNumber)
    {
        ...
        if ((mb_strlen($organizationNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $organizationNumber when calling VippsRecurringMerchantOnboarding., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[\\d-]{4,50}$/", ObjectSerializer::toString($organizationNumber)))) {
            throw new \InvalidArgumentException("invalid value for \$organizationNumber when calling VippsRecurringMerchantOnboarding., must conform to the pattern /^[\\d-]{4,50}$/.");
        }
