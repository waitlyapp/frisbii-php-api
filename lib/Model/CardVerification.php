...
class CardVerification implements ModelInterface, ArrayAccess
{
     ...
     * Sets state
     *
     * @param string $state Frisbii state: `accepted`, `soft_declined`, `hard_declined` or `processing_error`. Soft and hard declines indicate a card decline. A soft decline is possibly recoverable and a subsequent request with the same card may succeed. E.g. insufficient funds. A processing error indicates an error verifying the card either at Frisbii, the acquirer, or between Frisbii and the acquirer.
     *
     * @return $this
     */
     ...
     * Sets error
     *
     * @param string $error Frisbii error code if not state `accepted`. See [transaction errors](https://docs.frisbii.com/reference/transaction_errors).
     *
     * @return $this
     */
