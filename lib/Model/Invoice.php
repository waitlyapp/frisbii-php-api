...
class Invoice implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'cancelled' => '\DateTime',
        'authorized' => '\DateTime',
        'credits' => '\Billwerk\Model\CreditInvoice[]',
        'created' => '\DateTime',
        'plan_version' => 'int',
        'dunning_plan' => 'string',
        'discount_amount' => 'int',
        ...
        'order_lines' => '\Billwerk\Model\OrderLine[]',
        'additional_costs' => 'string[]',
        'transactions' => '\Billwerk\Model\Transaction[]',
        ...
        'debtor_id' => 'int',
        'credit_notes' => '\Billwerk\Model\InvoiceCreditNote[]'
    ];
     ...
     * Gets credits
     *
     * @return \Billwerk\Model\CreditInvoice[]
     */
     ...
     * Sets credits
     *
     * @param \Billwerk\Model\CreditInvoice[] $credits Credits applied to invoice
     *
     * @return $this
     */
     ...
     * Gets order_lines
     *
     * @return \Billwerk\Model\OrderLine[]
     */
     ...
     * Sets order_lines
     *
     * @param \Billwerk\Model\OrderLine[] $order_lines Order lines for invoice sorted by descending timestamp
     *
     * @return $this
     */
     ...
     * Sets transactions
     *
     * @param \Billwerk\Model\Transaction[] $transactions Invoice transactions
     *
     * @return $this
     */
     ...
     * Gets credit_notes
     *
     * @return \Billwerk\Model\InvoiceCreditNote[]
     */
     ...
     * Sets credit_notes
     *
     * @param \Billwerk\Model\InvoiceCreditNote[] $credit_notes Invoice credit notes
     *
     * @return $this
     */
