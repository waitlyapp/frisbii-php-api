...
class Invoice implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'order_lines' => '\Frisbii\Model\OrderLine[]',
        ...
        'billing_address' => '\Frisbii\Model\InvoiceBillingAddress',
        'shipping_address' => '\Frisbii\Model\InvoiceShippingAddress',
        'accounting_number' => 'string',
        'debtor_id' => 'int',
        'download_url' => 'string',
        'accounting_created_date' => '\DateTime',
        'invoice_file_type' => 'string',
        'credit_notes' => '\Frisbii\Model\InvoiceCreditNote[]'
    ];
    ...
    protected static $setters = [
        ...
        'invoice_file_type' => 'setInvoiceFileType',
    ...
    protected static $getters = [
        ...
        'invoice_file_type' => 'getInvoiceFileType',
    ...
    const TYPE_CO = 'co';
    const TYPE_CH = 'ch';
    const INVOICE_FILE_TYPE_PDF = 'pdf';
    const INVOICE_FILE_TYPE_PDF_XML = 'pdf_xml';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['invoice_file_type'] = isset($data['invoice_file_type']) ? $data['invoice_file_type'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['invoice_file_type']) && !in_array($this->container['invoice_file_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'invoice_file_type', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets order_lines
     *
     * @param \Frisbii\Model\OrderLine[] $order_lines Order lines for invoice sorted by descending timestamp
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\InvoiceBillingAddress
     */
     ...
     *
     * @param \Frisbii\Model\InvoiceBillingAddress $billing_address billing_address
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\InvoiceShippingAddress
     */
     ...
     *
     * @param \Frisbii\Model\InvoiceShippingAddress $shipping_address shipping_address
     *
     * @return $this
     */
     ...
     * Sets download_url
     *
     * @param string $download_url Link to the invoice or credit note PDF, available if PDF generation and accounting features are enabled (only for subscription invoices, not charges). Access requires authentication. See https://docs.frisbii.com/reference/authentication. The response is a binary PDF file.
     *
     * @return $this
     */
    ...
    /**
     * Gets invoice_file_type
     *
     * @return string
     */
    public function getInvoiceFileType()
    {
        return $this->container['invoice_file_type'];
    }

    /**
     * Sets invoice_file_type
     *
     * @param string $invoice_file_type The type of invoice file, e.g. `pdf`
     *
     * @return $this
     */
    public function setInvoiceFileType($invoice_file_type)
    {
        $allowedValues = $this->getInvoiceFileTypeAllowableValues();
        if (!is_null($invoice_file_type) && !in_array($invoice_file_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'invoice_file_type', must be one of '%s'",
                    implode("', '", $allowedValues)
        ...
        $this->container['invoice_file_type'] = $invoice_file_type;
     ...
     * Gets credit_notes
     *
     * @return \Frisbii\Model\InvoiceCreditNote[]
     */
     ...
     * Sets credit_notes
     *
     * @param \Frisbii\Model\InvoiceCreditNote[] $credit_notes Invoice credit notes
     *
     * @return $this
     */
