 ...
 */
class CreateSubscriptionPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSubscriptionPlan';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setHandle($handle)
    {
        ...
        if ((mb_strlen($handle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $handle when calling CreateSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setScheduleType($scheduleType)
    {
        ...
        if ((mb_strlen($scheduleType) < 1)) {
            throw new \InvalidArgumentException('invalid length for $scheduleType when calling CreateSubscriptionPlan., must be bigger than or equal to 1.');
        }
     ...
     * Sets currency
     *
     * @param string|null $currency Currency for the subscription plan in [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) three letter alpha code. If not provided the account default currency will be used.
     *
     * @return self
     */
    ...
    public function setFixedLifeTimeLength($fixedLifeTimeLength)
    {
        ...
        if (($fixedLifeTimeLength > 12000)) {
            throw new \InvalidArgumentException('invalid value for $fixedLifeTimeLength when calling CreateSubscriptionPlan., must be smaller than or equal to 12000.');
        }
    ...
    public function setIntervalLength($intervalLength)
    {
        ...
        if (($intervalLength > 12000)) {
            throw new \InvalidArgumentException('invalid value for $intervalLength when calling CreateSubscriptionPlan., must be smaller than or equal to 12000.');
        }
        if (($intervalLength < 1)) {
    ...
    public function setScheduleFixedHour($scheduleFixedHour)
    {
        ...
        if (($scheduleFixedHour > 23)) {
            throw new \InvalidArgumentException('invalid value for $scheduleFixedHour when calling CreateSubscriptionPlan., must be smaller than or equal to 23.');
        }
        if (($scheduleFixedHour < 0)) {
            throw new \InvalidArgumentException('invalid value for $scheduleFixedHour when calling CreateSubscriptionPlan., must be bigger than or equal to 0.');
        }
    ...
    public function setNoticePeriods($noticePeriods)
    {
        ...
        if (($noticePeriods > 12000)) {
            throw new \InvalidArgumentException('invalid value for $noticePeriods when calling CreateSubscriptionPlan., must be smaller than or equal to 12000.');
        }
        if (($noticePeriods < 0)) {
    ...
    public function setFixationPeriods($fixationPeriods)
    {
        ...
        if (($fixationPeriods > 12000)) {
            throw new \InvalidArgumentException('invalid value for $fixationPeriods when calling CreateSubscriptionPlan., must be smaller than or equal to 12000.');
        }
