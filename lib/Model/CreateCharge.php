...
class CreateCharge implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'amount' => 'int',
        'currency' => 'string',
        'customer' => '\Billwerk\Model\CreateCustomer',
        'metadata' => 'map[string,object]',
        'source' => 'string',
        'settle' => 'bool',
        'recurring' => 'bool',
        'parameters' => '\Billwerk\Model\ChargeParameters',
        'ordertext' => 'string',
        'order_lines' => '\Billwerk\Model\CreateOrderLine[]',
        'customer_handle' => 'string',
        'billing_address' => '\Billwerk\Model\InvoiceBillingAddress',
        'shipping_address' => '\Billwerk\Model\InvoiceShippingAddress',
        'use_pm_for_subscription' => 'bool',
        'text_on_statement' => 'string',
        'payment_method_reference' => 'string',
        'async' => 'bool',
        'acquirer_reference' => 'string',
        'account_funding_information' => '\Billwerk\Model\AccountFundingInformation',
     ...
     * Gets customer
     *
     * @return \Billwerk\Model\CreateCustomer
     */
     ...
     * Sets customer
     *
     * @param \Billwerk\Model\CreateCustomer $customer customer
     *
     * @return $this
     */
     ...
     * Gets parameters
     *
     * @return \Billwerk\Model\ChargeParameters
     */
     ...
     * Sets parameters
     *
     * @param \Billwerk\Model\ChargeParameters $parameters parameters
     *
     * @return $this
     */
     ...
     * Gets order_lines
     *
     * @return \Billwerk\Model\CreateOrderLine[]
     */
     ...
     * Sets order_lines
     *
     * @param \Billwerk\Model\CreateOrderLine[] $order_lines Order lines for the charge. The order lines controls the amount. Only required if charge/invoice does not already exist. If given for existing charge the order lines and amount are adjusted. A maximum of 100 order lines is allowed.
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\InvoiceBillingAddress
     */
     ...
     *
     * @param \Billwerk\Model\InvoiceBillingAddress $billing_address billing_address
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\InvoiceShippingAddress
     */
     ...
     *
     * @param \Billwerk\Model\InvoiceShippingAddress $shipping_address shipping_address
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\AccountFundingInformation
     */
     ...
     *
     * @param \Billwerk\Model\AccountFundingInformation $account_funding_information account_funding_information
     *
     * @return $this
     */
