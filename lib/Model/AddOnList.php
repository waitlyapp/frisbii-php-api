 ...
 */
class AddOnList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddOnList';
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling AddOnList., must be bigger than or equal to 10.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\AddOn[] $content List of add-ons for current page
     *
     * @return self
     */
