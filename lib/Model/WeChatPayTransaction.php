 ...
 */
class WeChatPayTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WeChatPayTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('wechatpayId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['wechatpayId'];
    }

    /**
     * Sets wechatpayId
     *
     * @param string|null $wechatpayId WeChat Pay id
     *
     * @return self
     */
    public function setWechatpayId($wechatpayId)
    {
        if (is_null($wechatpayId)) {
            throw new \InvalidArgumentException('non-nullable wechatpayId cannot be null');
        }
        $this->container['wechatpayId'] = $wechatpayId;
