 ...
 *
 * @category Class
 * @description Specifics in case of Verkkopankki transaction
 * @package  Frisbii
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class VerkkopankkiTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerkkopankkiTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('verkkopankkiId', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets verkkopankkiId
     *
     * @param string|null $verkkopankkiId VerkkopankkiTransaction id
     *
     * @return self
     */
    public function setVerkkopankkiId($verkkopankkiId)
    {
        if (is_null($verkkopankkiId)) {
            throw new \InvalidArgumentException('non-nullable verkkopankkiId cannot be null');
        }
