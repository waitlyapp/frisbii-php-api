 ...
 *
 * @category Class
 * @description A page in a paginated dispute list
 * @package  Frisbii
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class DisputeList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const RANGE_RESOLVED = 'resolved';
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size > 100)) {
            throw new \InvalidArgumentException('invalid value for $size when calling DisputeList., must be smaller than or equal to 100.');
        }
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling DisputeList., must be bigger than or equal to 10.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling DisputeList., must be bigger than or equal to 0.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\Dispute[] $content List of disputes for current page
     *
     * @return self
     */
     ...
     * Sets range
     *
     * @param string $range Time and date attribute used to time limit. Either `created` or `resolved`.
     *
     * @return self
     */
