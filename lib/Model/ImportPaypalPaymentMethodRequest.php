 ...
 */
class ImportPaypalPaymentMethodRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportPaypalPaymentMethodRequest';
    ...
    public const TOKEN_TYPE_VAULT = 'VAULT';
    public const TOKEN_TYPE_BILLING_AGREEMENT = 'BILLING_AGREEMENT';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['tokenType']) < 1)) {
            $invalidProperties[] = "invalid value for 'tokenType', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets tokenId
     *
     * @param string $tokenId The vault ID or the billing agreement ID, depending on the token type, of the payment method to be imported
     *
     * @return self
     */
    public function setTokenId($tokenId)
    {
        ...
        if ((mb_strlen($tokenId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tokenId when calling ImportPaypalPaymentMethodRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets tokenType
     *
     * @param string $tokenType The type of token used in the previous integration
     *
     * @return self
     */
    public function setTokenType($tokenType)
    {
        ...
        if ((mb_strlen($tokenType) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tokenType when calling ImportPaypalPaymentMethodRequest., must be bigger than or equal to 1.');
        }
