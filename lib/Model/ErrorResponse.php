...
class ErrorResponse implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $transaction_error Optional transaction error in the case the request involved a transaction processing. See [transaction errors](https://docs.frisbii.com/reference/transaction_errors).
     *
     * @return $this
     */
