...
class TransactionList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'to' => 'string',
        'from' => 'string',
        'content' => '\Frisbii\Model\Transaction[]',
        'range' => 'string',
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling TransactionList., must be bigger than or equal to 10.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\Transaction[] $content List of transactions for current page
     *
     * @return self
     */
