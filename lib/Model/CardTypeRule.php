...
class CardTypeRule extends RiskRule
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CardTypeRule';
    ...
    public const SET_UNKNOWN = 'UNKNOWN';
    public const SET_VISA = 'VISA';
    public const SET_MC = 'MC';
    public const SET_DANKORT = 'DANKORT';
    public const SET_VISA_DK = 'VISA_DK';
    public const SET_FFK = 'FFK';
    public const SET_VISA_ELEC = 'VISA_ELEC';
    public const SET_MAESTRO = 'MAESTRO';
    public const SET_LASER = 'LASER';
    public const SET_AMEX = 'AMEX';
    public const SET_DINERS = 'DINERS';
    public const SET_DISCOVER = 'DISCOVER';
    public const SET_JCB = 'JCB';
    public const SET_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    public function getSetAllowableValues()
    {
        return [
            ...
            self::SET_DISCOVER,
            self::SET_JCB,
            self::SET_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
