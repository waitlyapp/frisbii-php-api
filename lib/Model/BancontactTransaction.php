 ...
 */
class BancontactTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BancontactTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('bancontactId', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets bancontactId
     *
     * @param string|null $bancontactId Bancontact id
     *
     * @return self
     */
    public function setBancontactId($bancontactId)
    {
        if (is_null($bancontactId)) {
            throw new \InvalidArgumentException('non-nullable bancontactId cannot be null');
        }
