 ...
 */
class DiscountList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DiscountList';
    ...
    protected static $openAPITypes = [
        ...
        'to' => 'string',
        'from' => 'string',
        'content' => '\Frisbii\Model\Discount[]',
        'range' => 'string',
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling DiscountList., must be bigger than or equal to 10.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\Discount[] $content List of discounts for current page
     *
     * @return self
     */
