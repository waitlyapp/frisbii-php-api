 ...
 */
class ExpireSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpireSubscription';
    ...
    */
     ...
     *
     * @param string|null $compensationMethod Optional method for compensation of partial period, either `full_refund`, `prorated_refund` or `none. Refund compensation is only allowed for synchronous refund payment methods, e.g. credit cards.`
     *
     * @return self
     */
