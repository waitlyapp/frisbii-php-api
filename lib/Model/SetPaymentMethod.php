 ...
 */
class SetPaymentMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetPaymentMethod';
    ...
    */
     ...
     * Sets source
     *
     * @param string|null $source The payment method source. Either an existing payment method for the customer, e.g. existing card id `ca_...` or a one-time card token `ct_...`.
     *
     * @return self
     */
