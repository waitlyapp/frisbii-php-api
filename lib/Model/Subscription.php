    ...
    */
    ...
    public function setHandle($handle)
    {
        ...
        if ((mb_strlen($handle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $handle when calling Subscription., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling Subscription., must be bigger than or equal to 1.');
        }
    ...
    public function setPlan($plan)
    {
        ...
        if ((mb_strlen($plan) < 1)) {
            throw new \InvalidArgumentException('invalid length for $plan when calling Subscription., must be bigger than or equal to 1.');
        }
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling Subscription., must be bigger than or equal to 1.');
        }
    ...
    public function setTimezone($timezone)
    {
        ...
        if ((mb_strlen($timezone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling Subscription., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling Subscription., must be bigger than or equal to 1.');
        }
