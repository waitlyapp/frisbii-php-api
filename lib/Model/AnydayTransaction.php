 ...
 */
class AnydayTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnydayTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('anydayId', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets anydayId
     *
     * @param string|null $anydayId Anyday id
     *
     * @return self
     */
    ...
    {
        if (is_null($anydayId)) {
            throw new \InvalidArgumentException('non-nullable anydayId cannot be null');
        }
