 ...
 */
class TaxPolicyList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxPolicyList';
    ...
    protected static $openAPITypes = [
        ...
        'to' => 'string',
        'from' => 'string',
        'content' => '\Frisbii\Model\TaxPolicy[]',
        'range' => 'string',
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size > 100)) {
            throw new \InvalidArgumentException('invalid value for $size when calling TaxPolicyList., must be smaller than or equal to 100.');
        }
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling TaxPolicyList., must be bigger than or equal to 10.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling TaxPolicyList., must be bigger than or equal to 0.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\TaxPolicy[] $content List of tax policies for current page
     *
     * @return self
     */
