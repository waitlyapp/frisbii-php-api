 ...
 */
class SepaEbicsTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SepaEbicsTransaction';
    ...
    {
        $this->setIfExists('sepaEbicsId', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sepaEbicsId'] === null) {
            $invalidProperties[] = "'sepaEbicsId' can't be null";
        }
        if ($this->container['sepaEbicsMandate'] === null) {
            $invalidProperties[] = "'sepaEbicsMandate' can't be null";
        }
    ...
    {
        return $this->container['sepaEbicsId'];
    }

    /**
     * Sets sepaEbicsId
     *
     * @param string $sepaEbicsId SEPA EBICS id
     *
     * @return self
     */
    public function setSepaEbicsId($sepaEbicsId)
    {
        if (is_null($sepaEbicsId)) {
            throw new \InvalidArgumentException('non-nullable sepaEbicsId cannot be null');
        }
        $this->container['sepaEbicsId'] = $sepaEbicsId;
     ...
     *
     * @param \Frisbii\Model\SepaEbicsMandate $sepaEbicsMandate sepaEbicsMandate
     *
     * @return self
     */
