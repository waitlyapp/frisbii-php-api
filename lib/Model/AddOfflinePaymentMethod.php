 ...
 */
class AddOfflinePaymentMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddOfflinePaymentMethod';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['offlineAgreementHandle']) < 1)) {
            $invalidProperties[] = "invalid value for 'offlineAgreementHandle', the character length must be bigger than or equal to 1.";
        }
     ...
     *
     * @param string $offlineAgreementHandle The unique offline agreement handle per account, e.g. `offline-cash-dkk-1`.
     *
     * @return self
     */
    public function setOfflineAgreementHandle($offlineAgreementHandle)
    {
        ...
        if ((mb_strlen($offlineAgreementHandle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offlineAgreementHandle when calling AddOfflinePaymentMethod., must be bigger than or equal to 1.');
        }
