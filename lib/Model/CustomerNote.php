 ...
 */
class CustomerNote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerNote';
    ...
    */
    ...
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) < 1)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CustomerNote., must be bigger than or equal to 1.');
        }
     ...
     * Sets id
     *
     * @param string $id Unique id for note assigned by Frisbii
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling CustomerNote., must be bigger than or equal to 1.');
        }
     ...
     * Sets userName
     *
     * @param string|null $userName User name of the note creator
     *
     * @return self
     */
     ...
     * Sets userEmail
     *
     * @param string|null $userEmail User email of the note creator
     *
     * @return self
     */
