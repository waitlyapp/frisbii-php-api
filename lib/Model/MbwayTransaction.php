 ...
 */
class MbwayTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MbwayTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('mbWayId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['mbWayId'];
    }

    /**
     * Sets mbWayId
     *
     * @param string|null $mbWayId MB Way id
     *
     * @return self
     */
    public function setMbWayId($mbWayId)
    {
        if (is_null($mbWayId)) {
            throw new \InvalidArgumentException('non-nullable mbWayId cannot be null');
        }
        $this->container['mbWayId'] = $mbWayId;
