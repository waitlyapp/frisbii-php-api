...
/**
 * CreatePricingDto Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePricingDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePricingDto';
    ...
    */
    ...
    public function setUnitRanges($unitRanges)
    {
        ...
        if ((count($unitRanges) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unitRanges when calling CreatePricingDto., number of items must be greater than or equal to 1.');
        }
