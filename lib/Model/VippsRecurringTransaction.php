 ...
 */
class VippsRecurringTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VippsRecurringTransaction';
    ...
    {
        $this->setIfExists('vippsRecurringId', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['vippsRecurringMandate'] === null) {
            $invalidProperties[] = "'vippsRecurringMandate' can't be null";
        }
    ...
    {
        if (is_null($vippsRecurringId)) {
            throw new \InvalidArgumentException('non-nullable vippsRecurringId cannot be null');
        }
     ...
     *
     * @param object $vippsRecurringMandate Vipps Recurring mandate object in case of Vipps Recurring payment method
     *
     * @return self
     */
