...
class MailSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MailSettings';
    ...
    {
        $this->setIfExists('defaultFrom', $data ?? [], null);
    ...
    */
    ...
    public function setDefaultFrom($defaultFrom)
    {
        if (is_null($defaultFrom)) {
            throw new \InvalidArgumentException('non-nullable defaultFrom cannot be null');
        }
     ...
     * Sets bcc
     *
     * @param string|null $bcc Optional Bcc email address to use for all mails. Rfc 822 address.
     *
     * @return self
     */
     ...
     * Sets replyTo
     *
     * @param string|null $replyTo Optional Reply-To email address. Rfc 822 address.
     *
     * @return self
     */
