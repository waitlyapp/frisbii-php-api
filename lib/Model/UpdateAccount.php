    ...
    */
    ...
    public function setHandle($handle)
    {
        ...
        if ((mb_strlen($handle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $handle when calling UpdateAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setLocale($locale)
    {
        ...
        if ((mb_strlen($locale) < 1)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling UpdateAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setTimezone($timezone)
    {
        ...
        if ((mb_strlen($timezone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling UpdateAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country when calling UpdateAccount., must be bigger than or equal to 1.');
        }
     ...
     * Sets currency
     *
     * @param string|null $currency Currency for the account in [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) three letter alpha code
     *
     * @return self
     */
