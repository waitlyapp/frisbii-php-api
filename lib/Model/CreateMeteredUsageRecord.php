 ...
 */
class CreateMeteredUsageRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateMeteredUsageRecord';
    ...
    */
     ...
     * Sets created
     *
     * @param string|null $created Date the merchant selected as the usage record date.
     *
     * @return self
     */
