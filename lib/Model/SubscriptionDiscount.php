...
class SubscriptionDiscount implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'count' => 'int',
        'invoices' => 'string[]',
        'discount_dto' => '\Frisbii\Model\Discount',
        'apply_to' => 'string[]',
        'fixed_count' => 'int',
     ...
     * Sets name
     *
     * @param string $name Optional name overriding the discount name. If not defined the discount name will be used as order line text.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Optional description overriding the discount description. If not defined the discount description will be used.
     *
     * @return $this
     */
     ...
     * Sets discount_dto
     *
     * @param \Frisbii\Model\Discount $discount_dto discount_dto
     *
     * @return $this
     */
     ...
     * Sets apply_to
     *
     * @param string[] $apply_to Which order lines the discount is applicable to: `all`, `setup_fee`, `plan`, `additional_cost`, `add_on`, `ondemand` and `metered_billing_product`
     *
     * @return $this
     */
