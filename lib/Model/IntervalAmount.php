 ...
 */
class IntervalAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntervalAmount';
    ...
    */
    ...
    public function setFrom($from)
    {
        ...
        if ((mb_strlen($from) < 1)) {
            throw new \InvalidArgumentException('invalid length for $from when calling IntervalAmount., must be bigger than or equal to 1.');
        }
    ...
    public function setTo($to)
    {
        ...
        if ((mb_strlen($to) < 1)) {
            throw new \InvalidArgumentException('invalid length for $to when calling IntervalAmount., must be bigger than or equal to 1.');
        }
