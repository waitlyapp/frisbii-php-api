 ...
 */
class CreateSubscriptionAdditionalCost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSubscriptionAdditionalCost';
    ...
    */
    ...
    public function setHandle($handle)
    {
        ...
        if ((mb_strlen($handle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $handle when calling CreateSubscriptionAdditionalCost., must be bigger than or equal to 1.');
        }
    ...
    public function setOrdertext($ordertext)
    {
        ...
        if ((mb_strlen($ordertext) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ordertext when calling CreateSubscriptionAdditionalCost., must be bigger than or equal to 1.');
        }
