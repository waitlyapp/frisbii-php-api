 ...
 */
class BlikTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlikTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('blikId', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets blikId
     *
     * @param string|null $blikId Blik id
     *
     * @return self
     */
    ...
    {
        if (is_null($blikId)) {
            throw new \InvalidArgumentException('non-nullable blikId cannot be null');
        }
