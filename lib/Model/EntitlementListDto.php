...
/**
 * EntitlementListDto Class Doc Comment
 *
 * @category Class
 * @package  Frisbii
 * @author   OpenAPI Generator team
 ...
 */
class EntitlementListDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EntitlementListDto';
    ...
    protected static $openAPITypes = [
        ...
        'to' => 'string',
        'from' => 'string',
        'content' => '\Frisbii\Model\Entitlement[]',
        'range' => 'string',
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size > 100)) {
            throw new \InvalidArgumentException('invalid value for $size when calling EntitlementListDto., must be smaller than or equal to 100.');
        }
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling EntitlementListDto., must be bigger than or equal to 10.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling EntitlementListDto., must be bigger than or equal to 0.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\Entitlement[] $content List of entitlements for current page
     *
     * @return self
     */
