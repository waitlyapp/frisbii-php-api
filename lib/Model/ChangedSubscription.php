 ...
 */
class ChangedSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangedSubscription';
    ...
    protected static $openAPITypes = [
        ...
        'changeJournal' => '\Frisbii\Model\SubscriptionChangeJournal'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('changeJournal', $data ?? [], null);
    }
    ...
    */
    ...
    public function setHandle($handle)
    {
        ...
        if ((mb_strlen($handle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $handle when calling ChangedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling ChangedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setPlan($plan)
    {
        ...
        if ((mb_strlen($plan) < 1)) {
            throw new \InvalidArgumentException('invalid length for $plan when calling ChangedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ChangedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setTimezone($timezone)
    {
        ...
        if ((mb_strlen($timezone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling ChangedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ChangedSubscription., must be bigger than or equal to 1.');
        }
     ...
     * Gets changeJournal
     *
     * @return \Frisbii\Model\SubscriptionChangeJournal|null
     */
     ...
     * Sets changeJournal
     *
     * @param \Frisbii\Model\SubscriptionChangeJournal|null $changeJournal changeJournal
     *
     * @return self
     */
    public function setChangeJournal($changeJournal)
    {
        if (is_null($changeJournal)) {
            throw new \InvalidArgumentException('non-nullable changeJournal cannot be null');
        }
