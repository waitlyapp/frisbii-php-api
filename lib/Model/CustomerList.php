...
class CustomerList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'to' => 'string',
        'from' => 'string',
        'content' => '\Frisbii\Model\Customer[]',
        'range' => 'string',
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling CustomerList., must be bigger than or equal to 10.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\Customer[] $content List of customers for current page
     *
     * @return self
     */
