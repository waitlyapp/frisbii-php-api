 ...
 *
 * @category Class
 * @description Specifics in case of Giropay transaction
 * @package  Frisbii
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GiropayTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GiropayTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('giropayId', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets giropayId
     *
     * @param string|null $giropayId Giropay id
     *
     * @return self
     */
    public function setGiropayId($giropayId)
    {
        if (is_null($giropayId)) {
            throw new \InvalidArgumentException('non-nullable giropayId cannot be null');
        }
