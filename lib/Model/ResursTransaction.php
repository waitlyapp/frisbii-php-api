 ...
 */
class ResursTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResursTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('resursId', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets resursId
     *
     * @param string|null $resursId Resurs id
     *
     * @return self
     */
    ...
    {
        if (is_null($resursId)) {
            throw new \InvalidArgumentException('non-nullable resursId cannot be null');
        }
