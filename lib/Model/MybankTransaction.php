 ...
 */
class MybankTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MybankTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('mybankId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['mybankId'];
    }

    /**
     * Sets mybankId
     *
     * @param string|null $mybankId MyBank id
     *
     * @return self
     */
    public function setMybankId($mybankId)
    {
        if (is_null($mybankId)) {
            throw new \InvalidArgumentException('non-nullable mybankId cannot be null');
        }
        $this->container['mybankId'] = $mybankId;
