 ...
 */
class UpdatePayeverAgreement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePayeverAgreement';
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling UpdatePayeverAgreement., must be bigger than or equal to 1.');
        }
     ...
     * Sets clientId
     *
     * @param string|null $clientId Payever client id
     *
     * @return self
     */
     ...
     * Sets clientSecret
     *
     * @param string|null $clientSecret Payever client secret
     *
     * @return self
     */
