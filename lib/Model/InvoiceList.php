...
class InvoiceList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling InvoiceList., must be bigger than or equal to 10.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\Invoice[] $content List of invoices for current page
     *
     * @return self
     */
