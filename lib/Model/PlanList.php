...
class PlanList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling PlanList., must be bigger than or equal to 10.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\Plan[] $content List of plans for current page
     *
     * @return self
     */
