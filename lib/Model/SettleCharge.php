...
class SettleCharge implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'manual_settle' => '\Frisbii\Model\ManualSettleTransfer'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['manual_settle'] = isset($data['manual_settle']) ? $data['manual_settle'] : null;
    }
     ...
     * Sets order_lines
     *
     * @param \Frisbii\Model\CreateOrderLine[] $order_lines Optional new order lines to replace old order lines for the charge. The order lines controls the amount. The new amount must be less than or equal to the authorized amount. See `amount`.
     *
     * @return $this
     */
    ...
    {
        return $this->container['manual_settle'];
    }

    /**
     * Sets manual_settle
     *
     * @param \Frisbii\Model\ManualSettleTransfer $manual_settle manual_settle
     *
     * @return $this
     */
    public function setManualSettle($manual_settle)
    {
        $this->container['manual_settle'] = $manual_settle;
