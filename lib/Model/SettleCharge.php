...
class SettleCharge implements ModelInterface, ArrayAccess
{
     ...
     * Sets order_lines
     *
     * @param \Billwerk\Model\CreateOrderLine[] $order_lines Optional new order lines to replace old order lines for the charge. The order lines controls the amount. The new amount must be less than or equal to the authorized amount. See `amount`.
     *
     * @return $this
     */
