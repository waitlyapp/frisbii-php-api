 ...
 */
class ExtendKlarnaAuthResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtendKlarnaAuthResponse';
    ...
    */
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ExtendKlarnaAuthResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $acquirerMessage Details if extend klarna operation was not successful
     *
     * @return self
     */
