 ...
 */
class ImportMpsPaymentMethodRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportMpsPaymentMethodRequest';
    ...
    {
        $this->setIfExists('mobilePayId', $data ?? [], null);
        $this->setIfExists('reference', $data ?? [], null);
        $this->setIfExists('customer', $data ?? [], null);
        $this->setIfExists('customerHandle', $data ?? [], null);
        $this->setIfExists('cancelRedirectUrl', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mobilePayId'] === null) {
            $invalidProperties[] = "'mobilePayId' can't be null";
        }
        if ((mb_strlen($this->container['mobilePayId']) < 1)) {
            $invalidProperties[] = "invalid value for 'mobilePayId', the character length must be bigger than or equal to 1.";
        }
    ...
    {
        if (is_null($mobilePayId)) {
            throw new \InvalidArgumentException('non-nullable mobilePayId cannot be null');
        }

        if ((mb_strlen($mobilePayId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mobilePayId when calling ImportMpsPaymentMethodRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $cancelRedirectUrl cancelRedirectUrl
     *
     * @return self
     */
    public function setCancelRedirectUrl($cancelRedirectUrl)
    {
        if (is_null($cancelRedirectUrl)) {
            throw new \InvalidArgumentException('non-nullable cancelRedirectUrl cannot be null');
        }
