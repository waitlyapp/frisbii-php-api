 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateSubscriptionMeteredBillingProduct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateSubscriptionMeteredBillingProduct';
    ...
    protected static $swaggerTypes = [
        'vat' => 'float',
        'metered_billing_product_handle' => 'string',
        'unbilled_usage' => 'string',
        ...
        'tax_policy' => 'string',
        'unit_ranges' => '\Frisbii\Model\UnitRangeDto[]'
    ];
    ...
    protected static $swaggerFormats = [
        'vat' => 'float',
        'metered_billing_product_handle' => null,
        'unbilled_usage' => null,
    ...
    protected static $attributeMap = [
        'vat' => 'vat',
        'metered_billing_product_handle' => 'metered_billing_product_handle',
    ...
    protected static $setters = [
        'vat' => 'setVat',
        'metered_billing_product_handle' => 'setMeteredBillingProductHandle',
        'unbilled_usage' => 'setUnbilledUsage',
    ...
    protected static $getters = [
        'vat' => 'getVat',
        'metered_billing_product_handle' => 'getMeteredBillingProductHandle',
        'unbilled_usage' => 'getUnbilledUsage',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['metered_billing_product_handle'] = isset($data['metered_billing_product_handle']) ? $data['metered_billing_product_handle'] : null;
        $this->container['unbilled_usage'] = isset($data['unbilled_usage']) ? $data['unbilled_usage'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['metered_billing_product_handle'] === null) {
            $invalidProperties[] = "'metered_billing_product_handle' can't be null";
        }
        if ($this->container['unbilled_usage'] === null) {
            $invalidProperties[] = "'unbilled_usage' can't be null";
        }
        if ($this->container['pricing_strategy'] === null) {
            $invalidProperties[] = "'pricing_strategy' can't be null";
        }
    ...
    /**
     * Gets metered_billing_product_handle
     *
     * @return string
     */
    public function getMeteredBillingProductHandle()
    {
        return $this->container['metered_billing_product_handle'];
    }

    /**
     * Sets metered_billing_product_handle
     *
     * @param string $metered_billing_product_handle Handle of metered billing product that will be added to subscription
     *
     * @return $this
     */
    public function setMeteredBillingProductHandle($metered_billing_product_handle)
    {
        $this->container['metered_billing_product_handle'] = $metered_billing_product_handle;
    ...
    {
        return $this->container['unbilled_usage'];
    }

    /**
     * Sets unbilled_usage
     *
     * @param string $unbilled_usage The strategy for unbilled usage for this metered billing product if it was previously added to the subscription.
     *
     * @return $this
     */
    public function setUnbilledUsage($unbilled_usage)
    {
        $this->container['unbilled_usage'] = $unbilled_usage;
    ...
    {
        $allowedValues = $this->getPricingModelAllowableValues();
        if (!is_null($pricing_model) && !in_array($pricing_model, $allowedValues, true)) {
     ...
     * Sets unit_ranges
     *
     * @param \Frisbii\Model\UnitRangeDto[] $unit_ranges Unit ranges for this product
     *
     * @return $this
     */
