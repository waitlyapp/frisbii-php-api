...
/**
 * UpdateSepaEbicsAgreement Class Doc Comment
 *
 * @category Class
 * @package  Frisbii
 * @author   OpenAPI Generator team
 ...
 */
class UpdateSepaEbicsAgreement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSepaEbicsAgreement';
    ...
    */
    ...
    public function setScope($scope)
    {
        ...
        if ((mb_strlen($scope) < 1)) {
            throw new \InvalidArgumentException('invalid length for $scope when calling UpdateSepaEbicsAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyName($companyName)
    {
        ...
        if ((mb_strlen($companyName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling UpdateSepaEbicsAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling UpdateSepaEbicsAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setCreditorIdentifier($creditorIdentifier)
    {
        ...
        if ((mb_strlen($creditorIdentifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $creditorIdentifier when calling UpdateSepaEbicsAgreement., must be bigger than or equal to 1.');
        }
