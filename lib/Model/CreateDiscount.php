 ...
 */
class CreateDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDiscount';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateDiscount., must be bigger than or equal to 1.');
        }
    ...
    public function setHandle($handle)
    {
        ...
        if ((mb_strlen($handle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $handle when calling CreateDiscount., must be bigger than or equal to 1.');
        }
    ...
    public function setApplyTo($applyTo)
    {
        ...
        if ((count($applyTo) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $applyTo when calling CreateDiscount., number of items must be less than or equal to 2147483647.');
        }
        if ((count($applyTo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $applyTo when calling CreateDiscount., number of items must be greater than or equal to 1.');
        }
