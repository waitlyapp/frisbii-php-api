...
class PaymentMethodList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'to' => 'string',
        'from' => 'string',
        'content' => '\Frisbii\Model\PaymentMethodV2[]',
        'range' => 'string',
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling PaymentMethodList., must be bigger than or equal to 10.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\PaymentMethodV2[] $content List of payment methods for current page
     *
     * @return self
     */
