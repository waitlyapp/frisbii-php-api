 ...
 */
class UpdateUserGroups implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateUserGroups';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['groups']) > 2147483647)) {
    ...
    public function setGroups($groups)
    {
        ...
        if ((count($groups) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $groups when calling UpdateUserGroups., number of items must be less than or equal to 2147483647.');
        }
        if ((count($groups) < 1)) {
            throw new \InvalidArgumentException('invalid length for $groups when calling UpdateUserGroups., number of items must be greater than or equal to 1.');
        }
     ...
     *
     * @param string|null $currentPassword Current user password, required if modifying the current user's groups
     *
     * @return self
     */
