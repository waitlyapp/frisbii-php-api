 ...
 */
class SepaEbicsAgreement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SepaEbicsAgreement';
    ...
    */
    ...
    public function setScope($scope)
    {
        ...
        if ((mb_strlen($scope) < 1)) {
            throw new \InvalidArgumentException('invalid length for $scope when calling SepaEbicsAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling SepaEbicsAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyName($companyName)
    {
        ...
        if ((mb_strlen($companyName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling SepaEbicsAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling SepaEbicsAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setCreditorIdentifier($creditorIdentifier)
    {
        ...
        if ((mb_strlen($creditorIdentifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $creditorIdentifier when calling SepaEbicsAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setUserId($userId)
    {
        ...
        if ((mb_strlen($userId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $userId when calling SepaEbicsAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customerId)
    {
        ...
        if ((mb_strlen($customerId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling SepaEbicsAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setHostId($hostId)
    {
        ...
        if ((mb_strlen($hostId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $hostId when calling SepaEbicsAgreement., must be bigger than or equal to 1.');
        }
