 ...
 */
class EmvConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmvConfiguration';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('onboardingState', $data ?? [], null);
    }
    ...
    */
    ...
    public function setTokenRequestorId($tokenRequestorId)
    {
        ...
        if ((mb_strlen($tokenRequestorId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tokenRequestorId when calling EmvConfiguration., must be bigger than or equal to 1.');
        }
     ...
     * Sets cardScheme
     *
     * @param string $cardScheme cardScheme
     *
     * @return self
     */
    ...
    /**
     * Gets onboardingState
     *
     * @return string|null
     */
    public function getOnboardingState()
    {
        return $this->container['onboardingState'];
    }

    /**
     * Sets onboardingState
     *
     * @param string|null $onboardingState onboardingState
     *
     * @return self
     */
    public function setOnboardingState($onboardingState)
    {
        if (is_null($onboardingState)) {
            throw new \InvalidArgumentException('non-nullable onboardingState cannot be null');
        }
        $this->container['onboardingState'] = $onboardingState;
