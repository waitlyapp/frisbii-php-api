 ...
 *
 * @category Class
 * @description Specifics in case of SEPA transaction
 * @package  Frisbii
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SepaTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SepaTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sepaId', $data ?? [], null);
    ...
    */
     ...
     * Sets sepaId
     *
     * @param string|null $sepaId SEPA id
     *
     * @return self
     */
    ...
    {
        if (is_null($sepaId)) {
            throw new \InvalidArgumentException('non-nullable sepaId cannot be null');
        }
