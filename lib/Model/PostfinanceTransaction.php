 ...
 */
class PostfinanceTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostfinanceTransaction';
    ...
    protected static $setters = [
        ...
        'postfinanceId' => 'setPostfinanceId'
    ];
    ...
    protected static $getters = [
        ...
        'postfinanceId' => 'getPostfinanceId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('postfinanceId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['postfinanceId'];
    }

    /**
     * Sets postfinanceId
     *
     * @param string|null $postfinanceId PostFinance id
     *
     * @return self
     */
    public function setPostfinanceId($postfinanceId)
    {
        if (is_null($postfinanceId)) {
            throw new \InvalidArgumentException('non-nullable postfinanceId cannot be null');
        }
        $this->container['postfinanceId'] = $postfinanceId;
