 ...
 */
class PayeverAgreement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayeverAgreement';
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PayeverAgreement., must be bigger than or equal to 1.');
        }
