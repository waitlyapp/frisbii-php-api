...
class WebhookList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size > 100)) {
            throw new \InvalidArgumentException('invalid value for $size when calling WebhookList., must be smaller than or equal to 100.');
        }
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling WebhookList., must be bigger than or equal to 10.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling WebhookList., must be bigger than or equal to 0.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\Webhook[] $content List of webhooks for current page
     *
     * @return self
     */
