...
class CardTransaction implements ModelInterface, ArrayAccess
{
     ...
     * Sets card
     *
     * @param \Frisbii\Model\Card $card card
     *
     * @return $this
     */
     ...
     *
     * @param string $transaction_card_type Transaction card type. Will differ from `card_type` if co-branded card. Transaction card type is the card type used for the transaction. `unknown`, `visa`, `mc`, `dankort`, `visa_dk`, `ffk`, `visa_elec`, `maestro`, `laser`, `amex`, `diners`, `discover`, `jcb` or `china_union_pay`
     *
     * @return $this
     */
     ...
     * Sets risk_rule
     *
     * @param string $risk_rule If this parameter is set the transaction has either been flagged or declined by a Frisbii Risk Filter rule. For flag action rules the transaction can be successful, but may require special attention. For block action rules the decline error will be `risk_filter_block`.
     *
     * @return $this
     */
