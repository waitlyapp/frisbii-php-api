...
class Charge implements ModelInterface, ArrayAccess
{
     ...
     * Sets transaction
     *
     * @param string $transaction Transaction id assigned by Frisbii. Assigned when transaction is performed.
     *
     * @return $this
     */
     ...
     * Sets error
     *
     * @param string $error Frisbii error code if failed. See [transaction errors](https://docs.frisbii.com/reference/transaction_errors).
     *
     * @return $this
     */
     ...
     * Sets order_lines
     *
     * @param \Frisbii\Model\OrderLine[] $order_lines Order lines for charge
     *
     * @return $this
     */
     ...
     * Sets error_state
     *
     * @param string $error_state Frisbii error state if failed: `soft_declined`, `hard_declined` or `processing_error`. Soft and hard declines indicate a card decline. A soft decline is possibly recoverable and a subsequent request with the same card may succeed. E.g. insufficient funds. A processing error indicates an error processing the card either at Frisbii, the acquirer, or between Frisbii and the acquirer.
     *
     * @return $this
     */
