 ...
 */
class PayseraTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayseraTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payseraId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['payseraId'];
    }

    /**
     * Sets payseraId
     *
     * @param string|null $payseraId Paysera id
     *
     * @return self
     */
    public function setPayseraId($payseraId)
    {
        if (is_null($payseraId)) {
            throw new \InvalidArgumentException('non-nullable payseraId cannot be null');
        }
        $this->container['payseraId'] = $payseraId;
