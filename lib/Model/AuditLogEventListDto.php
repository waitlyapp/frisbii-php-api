...
/**
 * AuditLogEventListDto Class Doc Comment
 *
 * @category Class
 * @package  Frisbii
 * @author   OpenAPI Generator team
 ...
 */
class AuditLogEventListDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuditLogEventListDto';
    ...
    protected static $openAPITypes = [
        ...
        'to' => 'string',
        'from' => 'string',
        'content' => '\Frisbii\Model\AuditLogEventDto[]',
        'range' => 'string',
    ...
    public const RANGE_CREATED = 'created';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('range', $data ?? [], 'created');
    ...
    */
    ...
    public function setSize($size)
    {
        ...
        if (($size > 100)) {
            throw new \InvalidArgumentException('invalid value for $size when calling AuditLogEventListDto., must be smaller than or equal to 100.');
        }
        if (($size < 10)) {
            throw new \InvalidArgumentException('invalid value for $size when calling AuditLogEventListDto., must be bigger than or equal to 10.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling AuditLogEventListDto., must be bigger than or equal to 0.');
        }
     ...
     * Sets content
     *
     * @param \Frisbii\Model\AuditLogEventDto[] $content List of audit log events for current page
     *
     * @return self
     */
     ...
     * Sets range
     *
     * @param string|null $range Time and date attribute for time limit. Accepted value `created`.
     *
     * @return self
     */
     ...
     * Sets nextPageToken
     *
     * @param string|null $nextPageToken Pagination token to use to get the next page. Notice that page size and range should be the same for all page requests. If not present the last page has been reached.
     *
     * @return self
     */
