...
class PreparedSubscription implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'coupons' => 'string[]',
        'currency' => 'string',
        'invoices' => '\Frisbii\Model\Invoice[]',
        'plan_version' => 'int',
        ...
        'hosted_page_links' => '\Frisbii\Model\SubscriptionLinks',
        'subscription_discounts' => 'string[]',
        'pending_change' => '\Frisbii\Model\SubscriptionChange',
        'subscription_changes' => '\Frisbii\Model\SubscriptionChange[]',
        'subscription_add_ons' => 'string[]',
        'active_payment_methods' => 'string[]',
        'metered_billing_products' => 'string[]',
        'next_invoice' => '\Frisbii\Model\Invoice'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['next_invoice'] = isset($data['next_invoice']) ? $data['next_invoice'] : null;
    }
     ...
     * Sets invoices
     *
     * @param \Frisbii\Model\Invoice[] $invoices List of created (prepared) invoices for prepared subscription
     *
     * @return $this
     */
     ...
     *
     * @param \Frisbii\Model\SubscriptionLinks $hosted_page_links hosted_page_links
     *
     * @return $this
     */
     ...
     * Gets pending_change
     *
     * @return \Frisbii\Model\SubscriptionChange
     */
     ...
     * Sets pending_change
     *
     * @param \Frisbii\Model\SubscriptionChange $pending_change pending_change
     *
     * @return $this
     */
     ...
     *
     * @param \Frisbii\Model\SubscriptionChange[] $subscription_changes List of subscription changes both at most one pending and previously applied
     *
     * @return $this
     */
     ...
     *
     * @param string[] $metered_billing_products List of metered billing products attached to the subscription
     *
     * @return $this
     */
     ...
     * Sets next_invoice
     *
     * @param \Frisbii\Model\Invoice $next_invoice next_invoice
     *
     * @return $this
     */
