 ...
 */
class PreparedSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PreparedSubscription';
    ...
    protected static $openAPITypes = [
        ...
        'nextInvoice' => '\Frisbii\Model\Invoice'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('nextInvoice', $data ?? [], null);
    }
    ...
    */
    ...
    public function setHandle($handle)
    {
        ...
        if ((mb_strlen($handle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $handle when calling PreparedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling PreparedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setPlan($plan)
    {
        ...
        if ((mb_strlen($plan) < 1)) {
            throw new \InvalidArgumentException('invalid length for $plan when calling PreparedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling PreparedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setTimezone($timezone)
    {
        ...
        if ((mb_strlen($timezone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $timezone when calling PreparedSubscription., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PreparedSubscription., must be bigger than or equal to 1.');
        }
     ...
     * Sets invoices
     *
     * @param \Frisbii\Model\Invoice[]|null $invoices List of created (prepared) invoices for prepared subscription
     *
     * @return self
     */
    ...
    {
        return $this->container['nextInvoice'];
    }

    /**
     * Sets nextInvoice
     *
     * @param \Frisbii\Model\Invoice|null $nextInvoice nextInvoice
     *
     * @return self
     */
    public function setNextInvoice($nextInvoice)
    {
        if (is_null($nextInvoice)) {
            throw new \InvalidArgumentException('non-nullable nextInvoice cannot be null');
        }
        $this->container['nextInvoice'] = $nextInvoice;
