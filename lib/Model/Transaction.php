...
class Transaction implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'card_transaction' => '\Billwerk\Model\CardTransaction',
        'mpo_transaction' => '\Billwerk\Model\CardTransaction',
        'vipps_transaction' => '\Billwerk\Model\CardTransaction',
        'applepay_transaction' => '\Billwerk\Model\CardTransaction',
        'googlepay_transaction' => '\Billwerk\Model\CardTransaction',
        'manual_transaction' => '\Billwerk\Model\ManualTransaction',
        'viabill_transaction' => '\Billwerk\Model\ViabillTransaction',
        'anyday_transaction' => '\Billwerk\Model\AnydayTransaction',
        'santander_transaction' => '\Billwerk\Model\SantanderTransaction',
        'resurs_transaction' => '\Billwerk\Model\ResursTransaction',
        'klarna_transaction' => '\Billwerk\Model\KlarnaTransaction',
        'swish_transaction' => '\Billwerk\Model\SwishTransaction',
        'paypal_transaction' => '\Billwerk\Model\PaypalTransaction',
        'bancontact_transaction' => '\Billwerk\Model\BancontactTransaction',
        'blik_transaction' => '\Billwerk\Model\BlikTransaction',
        'ideal_transaction' => '\Billwerk\Model\IdealTransaction',
        'p24_transaction' => '\Billwerk\Model\P24Transaction',
        'trustly_transaction' => '\Billwerk\Model\TrustlyTransaction',
        'eps_transaction' => '\Billwerk\Model\EpsTransaction',
        'estonia_banks_transaction' => '\Billwerk\Model\EstoniaBanksTransaction',
        'latvia_banks_transaction' => '\Billwerk\Model\LatviaBanksTransaction',
        'lithuania_banks_transaction' => '\Billwerk\Model\LithuaniaBanksTransaction',
        'mbway_transaction' => '\Billwerk\Model\MbwayTransaction',
        'multibanco_transaction' => '\Billwerk\Model\MultibancoTransaction',
        'mybank_transaction' => '\Billwerk\Model\MybankTransaction',
        'payconiq_transaction' => '\Billwerk\Model\PayconiqTransaction',
        'paysafecard_transaction' => '\Billwerk\Model\PaysafecardTransaction',
        'paysera_transaction' => '\Billwerk\Model\PayseraTransaction',
        'postfinance_transaction' => '\Billwerk\Model\PostfinanceTransaction',
        'satispay_transaction' => '\Billwerk\Model\SatispayTransaction',
        'wechatpay_transaction' => '\Billwerk\Model\WeChatPayTransaction',
        'mps_transaction' => '\Billwerk\Model\MpsTransaction',
        'vipps_recurring_transaction' => '\Billwerk\Model\VippsRecurringTransaction',
     ...
     * Sets payment_type
     *
     * @param string $payment_type Payment type for transaction, either: `card`, `mpo`, `mobilepay`, `vipps`, `vipps_recurring`, `swish`, `viabill`, `anyday`, `manual`, `applepay`, `googlepay`, `paypal`, `klarna_pay_now`, `klarna_pay_later`, `klarna_slice_it`, `klarna_direct_bank_transfer`, `klarna_direct_debit`, `resurs`, `santander`, `mobilepay_subscriptions`, `emv_token`, `bcmc`, `blik`, `pp_blik_oc`, `giropay`, `ideal`, `p24`, `sepa`, `trustly`, or `verkkopankki`
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\CardTransaction
     */
     ...
     *
     * @param \Billwerk\Model\CardTransaction $card_transaction card_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Billwerk\Model\CardTransaction $mpo_transaction mpo_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Billwerk\Model\CardTransaction $vipps_transaction vipps_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Billwerk\Model\CardTransaction $applepay_transaction applepay_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Billwerk\Model\CardTransaction $googlepay_transaction googlepay_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\ManualTransaction
     */
     ...
     *
     * @param \Billwerk\Model\ManualTransaction $manual_transaction manual_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\ViabillTransaction
     */
     ...
     *
     * @param \Billwerk\Model\ViabillTransaction $viabill_transaction viabill_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\AnydayTransaction
     */
     ...
     *
     * @param \Billwerk\Model\AnydayTransaction $anyday_transaction anyday_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\SantanderTransaction
     */
     ...
     *
     * @param \Billwerk\Model\SantanderTransaction $santander_transaction santander_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\ResursTransaction
     */
     ...
     *
     * @param \Billwerk\Model\ResursTransaction $resurs_transaction resurs_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\KlarnaTransaction
     */
     ...
     *
     * @param \Billwerk\Model\KlarnaTransaction $klarna_transaction klarna_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\SwishTransaction
     */
     ...
     *
     * @param \Billwerk\Model\SwishTransaction $swish_transaction swish_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\PaypalTransaction
     */
     ...
     *
     * @param \Billwerk\Model\PaypalTransaction $paypal_transaction paypal_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\BancontactTransaction
     */
     ...
     *
     * @param \Billwerk\Model\BancontactTransaction $bancontact_transaction bancontact_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\BlikTransaction
     */
     ...
     *
     * @param \Billwerk\Model\BlikTransaction $blik_transaction blik_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\IdealTransaction
     */
     ...
     *
     * @param \Billwerk\Model\IdealTransaction $ideal_transaction ideal_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\P24Transaction
     */
     ...
     *
     * @param \Billwerk\Model\P24Transaction $p24_transaction p24_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\TrustlyTransaction
     */
     ...
     *
     * @param \Billwerk\Model\TrustlyTransaction $trustly_transaction trustly_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\EpsTransaction
     */
     ...
     *
     * @param \Billwerk\Model\EpsTransaction $eps_transaction eps_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\EstoniaBanksTransaction
     */
     ...
     *
     * @param \Billwerk\Model\EstoniaBanksTransaction $estonia_banks_transaction estonia_banks_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\LatviaBanksTransaction
     */
     ...
     *
     * @param \Billwerk\Model\LatviaBanksTransaction $latvia_banks_transaction latvia_banks_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\LithuaniaBanksTransaction
     */
     ...
     *
     * @param \Billwerk\Model\LithuaniaBanksTransaction $lithuania_banks_transaction lithuania_banks_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\MbwayTransaction
     */
     ...
     *
     * @param \Billwerk\Model\MbwayTransaction $mbway_transaction mbway_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\MultibancoTransaction
     */
     ...
     *
     * @param \Billwerk\Model\MultibancoTransaction $multibanco_transaction multibanco_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\MybankTransaction
     */
     ...
     *
     * @param \Billwerk\Model\MybankTransaction $mybank_transaction mybank_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\PayconiqTransaction
     */
     ...
     *
     * @param \Billwerk\Model\PayconiqTransaction $payconiq_transaction payconiq_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\PaysafecardTransaction
     */
     ...
     *
     * @param \Billwerk\Model\PaysafecardTransaction $paysafecard_transaction paysafecard_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\PayseraTransaction
     */
     ...
     *
     * @param \Billwerk\Model\PayseraTransaction $paysera_transaction paysera_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\PostfinanceTransaction
     */
     ...
     *
     * @param \Billwerk\Model\PostfinanceTransaction $postfinance_transaction postfinance_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\SatispayTransaction
     */
     ...
     *
     * @param \Billwerk\Model\SatispayTransaction $satispay_transaction satispay_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\WeChatPayTransaction
     */
     ...
     *
     * @param \Billwerk\Model\WeChatPayTransaction $wechatpay_transaction wechatpay_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\MpsTransaction
     */
     ...
     *
     * @param \Billwerk\Model\MpsTransaction $mps_transaction mps_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\VippsRecurringTransaction
     */
     ...
     *
     * @param \Billwerk\Model\VippsRecurringTransaction $vipps_recurring_transaction vipps_recurring_transaction
     *
     * @return $this
     */
