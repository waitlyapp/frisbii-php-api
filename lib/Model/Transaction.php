...
class Transaction implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'card_transaction' => '\Frisbii\Model\CardTransaction',
        'mpo_transaction' => '\Frisbii\Model\CardTransaction',
        'vipps_transaction' => '\Frisbii\Model\CardTransaction',
        'applepay_transaction' => '\Frisbii\Model\CardTransaction',
        'googlepay_transaction' => '\Frisbii\Model\CardTransaction',
        'manual_transaction' => '\Frisbii\Model\ManualTransaction',
        'viabill_transaction' => '\Frisbii\Model\ViabillTransaction',
        'anyday_transaction' => '\Frisbii\Model\AnydayTransaction',
        'santander_transaction' => '\Frisbii\Model\SantanderTransaction',
        'resurs_transaction' => '\Frisbii\Model\ResursTransaction',
        'klarna_transaction' => '\Frisbii\Model\KlarnaTransaction',
        'swish_transaction' => '\Frisbii\Model\SwishTransaction',
        'paypal_transaction' => '\Frisbii\Model\PaypalTransaction',
        'bancomatpay_transaction' => '\Frisbii\Model\BancomatPayTransaction',
        'bancontact_transaction' => '\Frisbii\Model\BancontactTransaction',
        'blik_transaction' => '\Frisbii\Model\BlikTransaction',
        'giropay_transaction' => '\Frisbii\Model\GiropayTransaction',
        'ideal_transaction' => '\Frisbii\Model\IdealTransaction',
        'p24_transaction' => '\Frisbii\Model\P24Transaction',
        'sepa_transaction' => '\Frisbii\Model\SepaTransaction',
        'sepa_ebics_transaction' => '\Frisbii\Model\SepaEbicsTransaction',
        'trustly_transaction' => '\Frisbii\Model\TrustlyTransaction',
        'verkkopankki_transaction' => '\Frisbii\Model\VerkkopankkiTransaction',
        'eps_transaction' => '\Frisbii\Model\EpsTransaction',
        'estonia_banks_transaction' => '\Frisbii\Model\EstoniaBanksTransaction',
        'latvia_banks_transaction' => '\Frisbii\Model\LatviaBanksTransaction',
        'lithuania_banks_transaction' => '\Frisbii\Model\LithuaniaBanksTransaction',
        'mbway_transaction' => '\Frisbii\Model\MbwayTransaction',
        'multibanco_transaction' => '\Frisbii\Model\MultibancoTransaction',
        'mybank_transaction' => '\Frisbii\Model\MybankTransaction',
        'payconiq_transaction' => '\Frisbii\Model\PayconiqTransaction',
        'paysafecard_transaction' => '\Frisbii\Model\PaysafecardTransaction',
        'paysera_transaction' => '\Frisbii\Model\PayseraTransaction',
        'postfinance_transaction' => '\Frisbii\Model\PostfinanceTransaction',
        'satispay_transaction' => '\Frisbii\Model\SatispayTransaction',
        'twint_transaction' => '\Frisbii\Model\TwintTransaction',
        'wechatpay_transaction' => '\Frisbii\Model\WeChatPayTransaction',
        'mps_transaction' => '\Frisbii\Model\MpsTransaction',
        'vipps_epayment_transaction' => '\Frisbii\Model\VippsEpaymentTransaction',
        'vipps_recurring_transaction' => '\Frisbii\Model\VippsRecurringTransaction',
        'offline_transaction' => '\Frisbii\Model\OfflineTransaction',
    ...
    protected static $swaggerFormats = [
        ...
        'twint_transaction' => null,
        'wechatpay_transaction' => null,
        'mps_transaction' => null,
        'vipps_epayment_transaction' => null,
    ...
    protected static $attributeMap = [
        ...
        'bancomatpay_transaction' => 'bancomatpay_transaction',
        ...
        'sepa_ebics_transaction' => 'sepa_ebics_transaction',
        ...
        'twint_transaction' => 'twint_transaction',
        'wechatpay_transaction' => 'wechatpay_transaction',
        'mps_transaction' => 'mps_transaction',
        'vipps_epayment_transaction' => 'vipps_epayment_transaction',
    ...
    protected static $setters = [
        ...
        'bancomatpay_transaction' => 'setBancomatpayTransaction',
        ...
        'sepa_ebics_transaction' => 'setSepaEbicsTransaction',
        ...
        'twint_transaction' => 'setTwintTransaction',
        'wechatpay_transaction' => 'setWechatpayTransaction',
        'mps_transaction' => 'setMpsTransaction',
        'vipps_epayment_transaction' => 'setVippsEpaymentTransaction',
        ...
        'accounting_invoice' => 'setAccountingInvoice',
    ...
    protected static $getters = [
        ...
        'bancomatpay_transaction' => 'getBancomatpayTransaction',
        ...
        'sepa_ebics_transaction' => 'getSepaEbicsTransaction',
        ...
        'twint_transaction' => 'getTwintTransaction',
        'wechatpay_transaction' => 'getWechatpayTransaction',
        'mps_transaction' => 'getMpsTransaction',
        'vipps_epayment_transaction' => 'getVippsEpaymentTransaction',
        ...
        'accounting_invoice' => 'getAccountingInvoice',
    ...
    const PAYMENT_TYPE_VIPPS_EPAYMENT = 'vipps_epayment';
    ...
    const PAYMENT_TYPE_SEPA_EBICS = 'sepa_ebics';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['bancomatpay_transaction'] = isset($data['bancomatpay_transaction']) ? $data['bancomatpay_transaction'] : null;
        ...
        $this->container['sepa_ebics_transaction'] = isset($data['sepa_ebics_transaction']) ? $data['sepa_ebics_transaction'] : null;
        ...
        $this->container['twint_transaction'] = isset($data['twint_transaction']) ? $data['twint_transaction'] : null;
        ...
        $this->container['vipps_epayment_transaction'] = isset($data['vipps_epayment_transaction']) ? $data['vipps_epayment_transaction'] : null;
        ...
        $this->container['accounting_invoice'] = isset($data['accounting_invoice']) ? $data['accounting_invoice'] : null;
     ...
     * Sets payment_type
     *
     * @param string $payment_type Payment type for transaction, either: `card`, `mpo`, `mobilepay`, `vipps`, `vipps_epayment`, `vipps_recurring`, `swish`, `viabill`, `anyday`, `manual`, `applepay`, `googlepay`, `paypal`, `klarna_pay_now`, `klarna_pay_later`, `klarna_slice_it`, `klarna_direct_bank_transfer`, `klarna_direct_debit`, `resurs`, `mobilepay_subscriptions`, `emv_token`, `bancomatpay`, `bcmc`, `blik`, `pp_blik_oc`, `giropay`, `ideal`, `p24`, `sepa`, `trustly`, `eps`, `estonia_banks`, `latvia_banks`, `lithuania_banks`, `mb_way`, `multibanco`, `mybank`, `payconiq`, `paysafecard`, `paysera`, `postfinance`, `satispay`, `twint`, `wechatpay`, `santander`, `verkkopankki`, `offline_cash`, `offline_bank_transfer`, or `offline_other`, `sepa_ebics`
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\CardTransaction
     */
     ...
     *
     * @param \Frisbii\Model\CardTransaction $card_transaction card_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Frisbii\Model\CardTransaction $mpo_transaction mpo_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Frisbii\Model\CardTransaction $vipps_transaction vipps_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Frisbii\Model\CardTransaction $applepay_transaction applepay_transaction
     *
     * @return $this
     */
     ...
     *
     * @param \Frisbii\Model\CardTransaction $googlepay_transaction googlepay_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\ManualTransaction
     */
     ...
     *
     * @param \Frisbii\Model\ManualTransaction $manual_transaction manual_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\ViabillTransaction
     */
     ...
     *
     * @param \Frisbii\Model\ViabillTransaction $viabill_transaction viabill_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\AnydayTransaction
     */
     ...
     *
     * @param \Frisbii\Model\AnydayTransaction $anyday_transaction anyday_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\SantanderTransaction
     */
     ...
     *
     * @param \Frisbii\Model\SantanderTransaction $santander_transaction santander_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\ResursTransaction
     */
     ...
     *
     * @param \Frisbii\Model\ResursTransaction $resurs_transaction resurs_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\KlarnaTransaction
     */
     ...
     *
     * @param \Frisbii\Model\KlarnaTransaction $klarna_transaction klarna_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\SwishTransaction
     */
     ...
     *
     * @param \Frisbii\Model\SwishTransaction $swish_transaction swish_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\PaypalTransaction
     */
     ...
     *
     * @param \Frisbii\Model\PaypalTransaction $paypal_transaction paypal_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\BancomatPayTransaction
     */
    public function getBancomatpayTransaction()
    {
        return $this->container['bancomatpay_transaction'];
    }

    /**
     * Sets bancomatpay_transaction
     *
     * @param \Frisbii\Model\BancomatPayTransaction $bancomatpay_transaction bancomatpay_transaction
     *
     * @return $this
     */
    public function setBancomatpayTransaction($bancomatpay_transaction)
    {
        $this->container['bancomatpay_transaction'] = $bancomatpay_transaction;
     ...
     *
     * @return \Frisbii\Model\BancontactTransaction
     */
     ...
     *
     * @param \Frisbii\Model\BancontactTransaction $bancontact_transaction bancontact_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\BlikTransaction
     */
     ...
     *
     * @param \Frisbii\Model\BlikTransaction $blik_transaction blik_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\GiropayTransaction
     */
     ...
     *
     * @param \Frisbii\Model\GiropayTransaction $giropay_transaction giropay_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\IdealTransaction
     */
     ...
     *
     * @param \Frisbii\Model\IdealTransaction $ideal_transaction ideal_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\P24Transaction
     */
     ...
     *
     * @param \Frisbii\Model\P24Transaction $p24_transaction p24_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\SepaTransaction
     */
     ...
     *
     * @param \Frisbii\Model\SepaTransaction $sepa_transaction sepa_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\SepaEbicsTransaction
     */
    public function getSepaEbicsTransaction()
    {
        return $this->container['sepa_ebics_transaction'];
    }

    /**
     * Sets sepa_ebics_transaction
     *
     * @param \Frisbii\Model\SepaEbicsTransaction $sepa_ebics_transaction sepa_ebics_transaction
     *
     * @return $this
     */
    public function setSepaEbicsTransaction($sepa_ebics_transaction)
    {
        $this->container['sepa_ebics_transaction'] = $sepa_ebics_transaction;
     ...
     *
     * @return \Frisbii\Model\TrustlyTransaction
     */
     ...
     *
     * @param \Frisbii\Model\TrustlyTransaction $trustly_transaction trustly_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\VerkkopankkiTransaction
     */
     ...
     *
     * @param \Frisbii\Model\VerkkopankkiTransaction $verkkopankki_transaction verkkopankki_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\EpsTransaction
     */
     ...
     *
     * @param \Frisbii\Model\EpsTransaction $eps_transaction eps_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\EstoniaBanksTransaction
     */
     ...
     *
     * @param \Frisbii\Model\EstoniaBanksTransaction $estonia_banks_transaction estonia_banks_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\LatviaBanksTransaction
     */
     ...
     *
     * @param \Frisbii\Model\LatviaBanksTransaction $latvia_banks_transaction latvia_banks_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\LithuaniaBanksTransaction
     */
     ...
     *
     * @param \Frisbii\Model\LithuaniaBanksTransaction $lithuania_banks_transaction lithuania_banks_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\MbwayTransaction
     */
     ...
     *
     * @param \Frisbii\Model\MbwayTransaction $mbway_transaction mbway_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\MultibancoTransaction
     */
     ...
     *
     * @param \Frisbii\Model\MultibancoTransaction $multibanco_transaction multibanco_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\MybankTransaction
     */
     ...
     *
     * @param \Frisbii\Model\MybankTransaction $mybank_transaction mybank_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\PayconiqTransaction
     */
     ...
     *
     * @param \Frisbii\Model\PayconiqTransaction $payconiq_transaction payconiq_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\PaysafecardTransaction
     */
     ...
     *
     * @param \Frisbii\Model\PaysafecardTransaction $paysafecard_transaction paysafecard_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\PayseraTransaction
     */
     ...
     *
     * @param \Frisbii\Model\PayseraTransaction $paysera_transaction paysera_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\PostfinanceTransaction
     */
     ...
     *
     * @param \Frisbii\Model\PostfinanceTransaction $postfinance_transaction postfinance_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\SatispayTransaction
     */
     ...
     *
     * @param \Frisbii\Model\SatispayTransaction $satispay_transaction satispay_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\TwintTransaction
     */
    public function getTwintTransaction()
    {
        return $this->container['twint_transaction'];
    }

    /**
     * Sets twint_transaction
     *
     * @param \Frisbii\Model\TwintTransaction $twint_transaction twint_transaction
     *
     * @return $this
     */
    public function setTwintTransaction($twint_transaction)
    {
        $this->container['twint_transaction'] = $twint_transaction;
     ...
     *
     * @return \Frisbii\Model\WeChatPayTransaction
     */
     ...
     *
     * @param \Frisbii\Model\WeChatPayTransaction $wechatpay_transaction wechatpay_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\MpsTransaction
     */
     ...
     *
     * @param \Frisbii\Model\MpsTransaction $mps_transaction mps_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\VippsEpaymentTransaction
     */
    public function getVippsEpaymentTransaction()
    {
        return $this->container['vipps_epayment_transaction'];
    }

    /**
     * Sets vipps_epayment_transaction
     *
     * @param \Frisbii\Model\VippsEpaymentTransaction $vipps_epayment_transaction vipps_epayment_transaction
     *
     * @return $this
     */
    public function setVippsEpaymentTransaction($vipps_epayment_transaction)
    {
        $this->container['vipps_epayment_transaction'] = $vipps_epayment_transaction;
     ...
     *
     * @return \Frisbii\Model\VippsRecurringTransaction
     */
     ...
     *
     * @param \Frisbii\Model\VippsRecurringTransaction $vipps_recurring_transaction vipps_recurring_transaction
     *
     * @return $this
     */
     ...
     *
     * @return \Frisbii\Model\OfflineTransaction
     */
     ...
     *
     * @param \Frisbii\Model\OfflineTransaction $offline_transaction offline_transaction
     *
     * @return $this
     */
    ...
    /**
     * Gets accounting_invoice
     *
     * @return string
     */
    public function getAccountingInvoice()
    {
        return $this->container['accounting_invoice'];
    }

    /**
     * Sets accounting_invoice
     *
     * @param string $accounting_invoice Accounting invoice number if this transaction belongs to an accounting invoice
     *
     * @return $this
     */
    public function setAccountingInvoice($accounting_invoice)
    {
        $this->container['accounting_invoice'] = $accounting_invoice;
     ...
     * Sets debtor_id
     *
     * @param int $debtor_id Customer debtor id if this transaction belongs to an accounting invoice
     *
     * @return $this
     */
     ...
     *
     * @param string $customer_handle Customer handle if this transaction belongs to an accounting invoice
     *
     * @return $this
     */
