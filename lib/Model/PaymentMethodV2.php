...
class PaymentMethodV2 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'failed' => '\DateTime',
        'created' => '\DateTime',
        'card' => '\Billwerk\Model\CardV2',
        'applepay' => '\Billwerk\Model\CardV2',
        'payment_type' => 'string',
        'mps_subscription' => '\Billwerk\Model\MpsSubscriptionV2',
        'vipps_recurring_subscription' => '\Billwerk\Model\VippsRecurringSubscription',
        'sepa_mandate' => '\Billwerk\Model\SepaMandate'
    ];
     ...
     * Sets card
     *
     * @param \Billwerk\Model\CardV2 $card card
     *
     * @return $this
     */
     ...
     * Sets applepay
     *
     * @param \Billwerk\Model\CardV2 $applepay applepay
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\MpsSubscriptionV2
     */
     ...
     *
     * @param \Billwerk\Model\MpsSubscriptionV2 $mps_subscription mps_subscription
     *
     * @return $this
     */
     ...
     *
     * @return \Billwerk\Model\VippsRecurringSubscription
     */
     ...
     *
     * @param \Billwerk\Model\VippsRecurringSubscription $vipps_recurring_subscription vipps_recurring_subscription
     *
     * @return $this
     */
     ...
     * Gets sepa_mandate
     *
     * @return \Billwerk\Model\SepaMandate
     */
     ...
     * Sets sepa_mandate
     *
     * @param \Billwerk\Model\SepaMandate $sepa_mandate sepa_mandate
     *
     * @return $this
     */
