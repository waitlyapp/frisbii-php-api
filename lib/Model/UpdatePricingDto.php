...
/**
 * UpdatePricingDto Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdatePricingDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePricingDto';
    ...
    */
    ...
    public function setUnitRanges($unitRanges)
    {
        ...
        if ((count($unitRanges) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unitRanges when calling UpdatePricingDto., number of items must be greater than or equal to 1.');
        }
