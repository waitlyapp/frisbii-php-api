 ...
 */
class MpsTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MpsTransaction';
    ...
    protected static $openAPITypes = [
        'mpsId' => 'string',
        'mpsSubscription' => '\Frisbii\Model\MpsSubscription',
    ...
    public const MPS_PAYMENT_TYPE_REGULAR = 'regular';
    public const MPS_PAYMENT_TYPE_ONE_OFF_CIT = 'one_off_cit';
    public const MPS_PAYMENT_TYPE_ONE_OFF_MIT = 'one_off_mit';
    public const MPS_PAYMENT_TYPE_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    public function getMpsPaymentTypeAllowableValues()
    {
        return [
            ...
            self::MPS_PAYMENT_TYPE_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    {
        $this->setIfExists('mpsId', $data ?? [], null);
        $this->setIfExists('mpsSubscription', $data ?? [], null);
        $this->setIfExists('mpsPaymentType', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['mpsPaymentType']) && !in_array($this->container['mpsPaymentType'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'mpsPaymentType', must be one of '%s'",
                $this->container['mpsPaymentType'],
    ...
    {
        if (is_null($mpsId)) {
            throw new \InvalidArgumentException('non-nullable mpsId cannot be null');
        }
     ...
     *
     * @return \Frisbii\Model\MpsSubscription
     */
     ...
     *
     * @param \Frisbii\Model\MpsSubscription $mpsSubscription mpsSubscription
     *
     * @return self
     */
    ...
    {
        if (is_null($mpsPaymentType)) {
            throw new \InvalidArgumentException('non-nullable mpsPaymentType cannot be null');
        }
        $allowedValues = $this->getMpsPaymentTypeAllowableValues();
