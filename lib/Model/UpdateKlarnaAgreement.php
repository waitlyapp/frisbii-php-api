 ...
 */
class UpdateKlarnaAgreement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateKlarnaAgreement';
    ...
    */
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling UpdateKlarnaAgreement., must be bigger than or equal to 1.');
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UpdateKlarnaAgreement., must be bigger than or equal to 1.');
        }
