 ...
 */
class PayconiqTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayconiqTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payconiqId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['payconiqId'];
    }

    /**
     * Sets payconiqId
     *
     * @param string|null $payconiqId Payconiq id
     *
     * @return self
     */
    public function setPayconiqId($payconiqId)
    {
        if (is_null($payconiqId)) {
            throw new \InvalidArgumentException('non-nullable payconiqId cannot be null');
        }
        $this->container['payconiqId'] = $payconiqId;
