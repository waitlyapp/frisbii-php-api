 ...
 */
class TwintTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TwintTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('twintId', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['twintId'];
    }

    /**
     * Sets twintId
     *
     * @param string|null $twintId Twint id
     *
     * @return self
     */
    public function setTwintId($twintId)
    {
        if (is_null($twintId)) {
            throw new \InvalidArgumentException('non-nullable twintId cannot be null');
        }
        $this->container['twintId'] = $twintId;
