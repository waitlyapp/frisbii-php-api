 ...
 */
class P24Transaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'P24Transaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('p24Id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets p24Id
     *
     * @param string|null $p24Id P24 id
     *
     * @return self
     */
    ...
    {
        if (is_null($p24Id)) {
            throw new \InvalidArgumentException('non-nullable p24Id cannot be null');
        }
