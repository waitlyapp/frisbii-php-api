 ...
 */
class PaypalTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaypalTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('paypalId', $data ?? [], null);
    ...
    */
     ...
     * Sets paypalId
     *
     * @param string|null $paypalId PayPal id
     *
     * @return self
     */
    ...
    {
        if (is_null($paypalId)) {
            throw new \InvalidArgumentException('non-nullable paypalId cannot be null');
        }
