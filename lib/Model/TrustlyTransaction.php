 ...
 */
class TrustlyTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrustlyTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('trustlyId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['trustlyId'];
    }

    /**
     * Sets trustlyId
     *
     * @param string|null $trustlyId Trustly id
     *
     * @return self
     */
    public function setTrustlyId($trustlyId)
    {
        if (is_null($trustlyId)) {
            throw new \InvalidArgumentException('non-nullable trustlyId cannot be null');
        }
        $this->container['trustlyId'] = $trustlyId;
