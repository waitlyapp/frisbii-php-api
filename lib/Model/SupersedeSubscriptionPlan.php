 ...
 */
class SupersedeSubscriptionPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupersedeSubscriptionPlan';
    ...
    public const SUPERSEDE_MODE_NO_SUB_UPDATE = 'no_sub_update';
    public const SUPERSEDE_MODE_SCHEDULED_SUB_UPDATE = 'scheduled_sub_update';
    public const SUPERSEDE_MODE_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    public function getSupersedeModeAllowableValues()
    {
        return [
            ...
            self::SUPERSEDE_MODE_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('supersedeMode', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['supersedeMode']) && !in_array($this->container['supersedeMode'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'supersedeMode', must be one of '%s'",
                $this->container['supersedeMode'],
                implode("', '", $allowedValues)
            );
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SupersedeSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setScheduleType($scheduleType)
    {
        ...
        if ((mb_strlen($scheduleType) < 1)) {
            throw new \InvalidArgumentException('invalid length for $scheduleType when calling SupersedeSubscriptionPlan., must be bigger than or equal to 1.');
        }
    ...
    public function setFixedLifeTimeLength($fixedLifeTimeLength)
    {
        ...
        if (($fixedLifeTimeLength > 12000)) {
            throw new \InvalidArgumentException('invalid value for $fixedLifeTimeLength when calling SupersedeSubscriptionPlan., must be smaller than or equal to 12000.');
        }
    ...
    public function setIntervalLength($intervalLength)
    {
        ...
        if (($intervalLength > 12000)) {
            throw new \InvalidArgumentException('invalid value for $intervalLength when calling SupersedeSubscriptionPlan., must be smaller than or equal to 12000.');
        }
        if (($intervalLength < 1)) {
    ...
    public function setScheduleFixedHour($scheduleFixedHour)
    {
        ...
        if (($scheduleFixedHour > 23)) {
            throw new \InvalidArgumentException('invalid value for $scheduleFixedHour when calling SupersedeSubscriptionPlan., must be smaller than or equal to 23.');
        }
        if (($scheduleFixedHour < 0)) {
            throw new \InvalidArgumentException('invalid value for $scheduleFixedHour when calling SupersedeSubscriptionPlan., must be bigger than or equal to 0.');
        }
    ...
    public function setNoticePeriods($noticePeriods)
    {
        ...
        if (($noticePeriods > 12000)) {
            throw new \InvalidArgumentException('invalid value for $noticePeriods when calling SupersedeSubscriptionPlan., must be smaller than or equal to 12000.');
        }
        if (($noticePeriods < 0)) {
    ...
    public function setFixationPeriods($fixationPeriods)
    {
        ...
        if (($fixationPeriods > 12000)) {
            throw new \InvalidArgumentException('invalid value for $fixationPeriods when calling SupersedeSubscriptionPlan., must be smaller than or equal to 12000.');
        }
     ...
     * Sets supersedeMode
     *
     * @param string|null $supersedeMode Action to take after a subscription plan is superseded, one of the following: `no_sub_update` or `scheduled_sub_update`. Default is `no_sub_update`. Scheduled sub update will change plan at next subscription renewal.
     *
     * @return self
     */
    public function setSupersedeMode($supersedeMode)
    {
        if (is_null($supersedeMode)) {
            throw new \InvalidArgumentException('non-nullable supersedeMode cannot be null');
        }
        $allowedValues = $this->getSupersedeModeAllowableValues();
        if (!in_array($supersedeMode, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'supersedeMode', must be one of '%s'",
                    $supersedeMode,
