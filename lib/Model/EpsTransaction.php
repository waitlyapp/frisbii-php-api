 ...
 */
class EpsTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EpsTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('epsId', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets epsId
     *
     * @param string|null $epsId Eps id
     *
     * @return self
     */
    ...
    {
        if (is_null($epsId)) {
            throw new \InvalidArgumentException('non-nullable epsId cannot be null');
        }
